...
/*------------------------------------------------------------------------------*/
    ...
    $(document).ready(function () {
        $(".slick_slider").slick({
            ...
            arrows: false,
            dots: false,
            autoplay: true, // Auto slide ko enable karne ke liye true set karein
            autoplaySpeed: 3000, // Auto slide ke liye speed set karein (ms mein)
            centerMode: false,
            responsive: [
                {
                    breakpoint: 1360,
...
// last section script tab section
