    ...
    <div class="details-box-blogview">
        ...
        <div class="fle_xdisplay_vbdiv">
            <div class="fle_xdisplay_vbdivinner">
                @foreach ($articleBlog as $articleBlogs)
                    <div class="viewBlogDiv">
                        <h5>Title : {{ $articleBlogs->blog_title }}</h5>
                        <p>Disc : {{ $articleBlogs->blog_desc }}</p>
                        <div class="innerDivBtnStylevb">
                            <a href="{{ url('/Admin/editBlog') }}/{{ $articleBlogs->id }}"><button>Edit</button></a>
                            <a href="{{ url('/Admin/deleteBlog') }}/{{ $articleBlogs->id }}"><button>Delete</button></a>
                        </div>
                    </div>
                @endforeach
            </div>
