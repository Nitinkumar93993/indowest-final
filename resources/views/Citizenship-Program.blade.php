                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/CITIZENSHIP-PROGRAM.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">Citizenship Program</p>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> Citizenship Program</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">Citizenship Program</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">Citizenship Program</h4>
                                        <p class="p-express">The legal position of belonging to the Australian community, with all the rights and benefits that come with it, is known as
                                            Australian citizenship. It implies that you have the right to reside and work in Australia, as well as to take advantage of any
                                            government benefits and protections. <br><br>

                                            You must fulfill the requirements in order to become an Australian citizen, which include being a permanent resident, having
                                            excellent moral character, and passing the citizenship test. You will be eligible to vote in state, federal, and local elections
                                            after obtaining Australian citizenship. Additionally, you are qualified to use specific government services and submit an
                                            application for an Australian passport.
                                            <br><br>

                                            Australian citizenship also comes with responsibilities, such as obeying Australian laws, paying taxes, and defending the country if
                                            required. If you are interested to apply for Australian citizenship, then keep scrolling below to know such amazing information.
                                        </p>
                                        <!-- <br> -->

                                        <h4 class="">Australian Citizenship Types</h4>
                                        <p class="p-express">Australian citizenship is the sole kind of citizenship that is offered in Australia. Nonetheless, there are other methods via which
                                            an individual can become an Australian citizen:
                                        </p>

                                        <p class="p-express"><b> 1. Citizenship by Birth:</b> Australian citizenship is automatically acquired by anyone born in an Australian territory to at least one
                                            parent, who must also be a permanent resident or citizen of Australia.

                                        </p>
                                        <p class="p-express"><b>2. Australian Citizenship by Descent:</b> You could be able to obtain Australian citizenship by descent if at least one of your parents
                                            held Australian citizenship at the time of your birth.
                                        </p>
                                        <p class="p-express"><b>3. Citizenship by Conferral: </b>This is the most typical method of becoming an Australian citizen. To petition for citizenship, you
                                            must first become a permanent resident of the United States and subsequently Australian Citizenship
                                        </p>
                                        <p class="p-express"><b>4. Citizenship by Adoption:</b> You can be qualified for Australian citizenship by adoption if you were adopted by an Australian citizen.
                                        </p>
                                        <p class="p-express"><b>5. Citizenship by Resumption:</b> You might be able to regain your citizenship if you were a former Australian citizen who renounced or
                                            lost it.
                                        </p>
                                        <p class="p-express">There may be differences in the prerequisites and qualifying standards for every type of citizenship. To learn more about the
                                            specific procedures pertaining to citizenship categories, simply visit our website or give our specialists a call
                                        </p>

                                        <!-- <br> -->

                                        <h4 class="">In general, to become an Australian citizen, you must:</h4>


                                        <p class="p-express">
                                            <b> Satisfy the prerequisites:</b> The requirements are as follows: one must be of excellent character, have no prior criminal convictions,
                                            have resided in Australia for at least four years, and be a permanent resident of Australia for at least one year.

                                        </p>


                                        <p class="p-express"> <b> Supporting documentation:</b> You should be required to obtain and present documentation attesting to your identity, place of
                                            residence, and other prerequisites. These records consist of things like your passport, birth certificate, character references, and
                                            evidence of residency.
                                        </p>


                                        <p class="p-express"> <b> Finish the application:</b> You have two options for applying for citizenship: online or on paper. Certain personal information about
                                            the candidate, including name, permanent or temporary address, and trustworthy contact details, will be requested on the form
                                        </p>


                                        <p class="p-express"><b>Pay the application fee:</b> Depending on your situation, there is a fee associated with applying for and receiving Australian
                                            citizenship. The website of the Department of Home Affairs has the current fee listed
                                        </p>


                                        <p class="p-express"><b>Apply for citizenship:</b> You have the option of applying in person or online. The most crucial stage is to apply for it and submit
                                            the necessary paperwork, along with identification and residency evidence.
                                        </p>


                                        <p class="p-express"><b>Take a citizenship test:</b> You will receive an invitation to take a citizenship test if your application is accepted. The purpose of
                                            the test is to evaluate your understanding of Australian institutions, values, and customs.
                                        </p>
                                        ...
                                        <p class="p-express"><b> Participate in a citizenship ceremony:</b> Following test success, you will be invited to a ceremony where you will receive your
                                            citizenship certificate and be asked to swear allegiance to Australia
                                        </p>

                                        <h4 class="">There are obligations and benefits associated with being an Australian citizen</h4>
                                        <p class="p-express">
                                            Citizenship in Australia entails the following obligations:
                                        </p>


                                        <p class="p-express">
                                            <b> Respecting Australian laws:</b> You have an obligation to abide by all Australian laws and regulations as an Australian citizen.
                                        </p>
                                        <p class="p-express">
                                            <b> Paying taxes:</b> In Australia, you have to pay taxes on your property, goods and services, and income.
                                        </p>
                                        <p class="p-express">
                                            <b> Protecting Australia: </b>Should the need arise, you can be asked to join the Australian Defence Force in order to defend the nation.
                                        </p>
                                        <p class="p-express">
                                            <b> Election voting:</b> You are entitled to vote in local, state, and federal government elections as an Australian citizen.
                                        </p>
                                        <p class="p-express">
                                            <b>Jury duty:</b> You might be expected to serve on a jury in a court of law or in another official capacity.
                                        </p>
                                        ...
                                        <h4 class="">Citizenship in Australia confers the following benefits:</h4>

                                        <ul class="ani-ul">
                                            <li> Living and working in Australia: You have the unrestricted right to live and work in Australia as an Australian citizen.
                                            </li>
                                            <li>Access to government services: Social security, healthcare, and education are just a few of the services you can get from the
                                                government.
                                            </li>
                                            <li>Travel: There are no restrictions on entering or leaving Australia.</li>
                                            <li>Apply for an Australian passport: As an Australian citizen, you are permitted to go abroad only after submitting an application
                                                for an Australian passport.
                                            </li>
                                            <li>Taking part in civic life: Through volunteering, joining a community group, and other endeavors, you can actively engage in civic
                                                life and make a positive impact on the community.</li>
                                            <li>It is significant to remember that all Australian citizens, regardless of how they obtained their citizenship, are entitled to these
                                        ...
                                        <h4 class="">What is the duration required to become an Australian citizen?</h4>
                                        <p class="p-express">The length of time required to become an Australian citizen varies based on the specific situation and the length of time required
                                            to process citizenship. Typically, in order to petition for citizenship, you need to have been in Australia for at least three of
                                            the four years that you held a permanent resident visa. <br> <br>

                                            The processing period for citizenship applications can range from several months to more than a year, contingent on a number of
                                            factors including the intricacy of your case, the volume of applications being handled by the Department of Home Affairs, and any
                                            hold-ups in acquiring necessary documentation or additional information.<br> <br>

                                            You will receive an invitation to attend a citizenship ceremony, which may be hosted by the Department of Home Affairs or your local
                                            municipality, if your application is accepted. After your application is accepted, the ceremony is often place within a few months,
                                            though it may also depend on when dates are available in your community.<br> <br>

                                            From the time you initially enter Australia as a permanent resident until you are awarded citizenship, the process of becoming an
                                            Australian citizen might take many years. When preparing your citizenship application, it is best to get professional guidance and
                                            assistance as the process can be intricate and requires close attention to detail. For assistance with Australian citizenship, please
                                            contact us!
                                        </p>
                                    </div>
                                </div>
