                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/EXPRESS-ENTRY.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">EXPRESS ENTRY</p>
                                </div>
                            </div>
                        </aside>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6 mt-15">
                                            ...
                                            <input type="date" class="form-control" id="inputEmail4" placeholder="DOB" aria-label="" required>
                                        </div>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> ABOUT EXPRESS ENTRY</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">ABOUT EXPRESS ENTRY</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">EXPRESS ENTRY</h4>
                                        <p class="p-express">The Express Entry program offered by IndoWest Immigration is a specially designed route for
                                            qualified people looking to move to Canada. The Comprehensive Ranking System is used to evaluate
                                            candidates based on a variety of criteria, including education, work experience, language ability
                                            , and more (CRS). Throughout the application process, IndoWest Immigration offers thorough help
                                            to make sure candidates are ready and equipped to meet Express Entry requirements. They provide
                                            individualized counsel, help with paperwork, and interview preparation with a committed staff of
                                            immigration professionals. IndoWest seeks to expedite the immigration process so that qualified
                                            workers can effectively settle and make a positive contribution to Canada's multicultural
                                            society. IndoWest Immigration works to enable people all over the world to realise their ambition
                                            of beginning a new life in Canada by utilising their knowledge and resources.</p>
                                        <!-- <br> -->

                                        <!-- <br> -->

                                        <h4 class="">The Three Programs to apply under Canada Express Entry Eligibility: </h4>


                                        <p class="p-express"><b> The CEC, or Canadian Experience Class</b></p>

                                        <p class="p-express">Those who wish to become residents of Canada and have three years of work experience there should apply for Canada express admission.
                                            The paid salary and earned commission are used to compute work experience. Volunteer work and unpaid internships might not be taken
                                            into account. In accordance with the National Occupational Qualifications (NOC) of Canada, one's work experience is limited to TEER
                                            0, 1, 2, or 3 categories. Work experience from coworkers or as a freelancer is likewise not accepted into this program. It is not
                                            necessary to have any particular schooling to advance in this category.
                                        </p>
                                        <p class="p-express"><b> The CEC, or Canadian Experience Class</b></p>
                                        ...
                                        <p class="p-express"><b> The Federal Program for Skilled Workers (FSW)</b></p>

                                        <p class="p-express">to submit an application for this program. You need to have the necessary education, experience, and language skills. Gaining
                                            experience in international job is necessary for permanent residency in Canada. Once you fulfill all of these conditions, you will
                                            be evaluated based on six criteria: age, work history, education, adaptability, language proficiency, and a valid job offer. For
                                            the federal skilled worker program, the candidate with the highest assessment rank will be chosen.
                                        </p>
                                        <p class="p-express"><b> Federal Skilled Trades Program (FST) </b></p>

                                        <p class="p-express">If an individual falls in the skilled trade category, then it will be possible to apply for becoming a permanent resident. A
                                            candidate must have a minimum of 2 years of experience and a certificate of qualification to meet the requirements. The main
                                            difference between FSW and FST is eligibility. To improve your rank in FST you must meet the requirements of proof of funds,
                                            Admissibility, Skilled work experience, Language ability, Education, and Where you can live in Canada, etc. for more info check the
                                            official link.
                                        </p>
                                        ...
                                        <h4 class="">2. How does it work? </h4> <br>


                                        <p class="p-express"><b> </b></p>
                                        <p class="p-express">You can verify your eligibility to apply for Canada immigration express entry by using the information we covered above. You will be
                                            questioned regarding the specifics of the job offer, your age, nationality, and family members. If you meet the conditions for
                                            express admission into Canada, you will receive comprehensive instructions

                                        <p class="p-express"><b>1. Determine your rating</b></p>
                                        <p class="p-express">Send in your profile so that the CRS (Comprehensive Ranking System) can assess it. The file will be ranked in the express entry pool
                                            following the evaluation. Your score needs to be higher than the required minimum in order to receive the invitation
                                        </p>

                                        <p class="p-express"><b>2. Prepare the necessary paperwork.</b></p>
                                        <p class="p-express">Following the eligibility exam, you will require a few crucial papers for additional processing, including your results, your
                                            permanent residency credentials, evidence of your tie to a Canadian family, and a few digital images to verify your identity.
                                        </p>
                                        <p class="p-express"><b>3. Complete the Entry Profile form. </b></p>
                                        <p class="p-express">This is the first step in entering the pool to submit a file if you wish to relocate to Canada as a skilled worker. You will be
                                            evaluated in this based on a number of variables. It is not a guarantee that completing the entry profile will result in an
                                            invitation for permanent residency. identity.
                                        </p>
                                        <p class="p-express"><b>4. Receive an Invitation </b></p>
                                        <p class="p-express">The candidates who have the highest CRS scores will be chosen for permanent residence in the final stage. The creation of an EE
                                            profile is free of charge, but if you receive an Invitation (ITA), you will need to pay costs and submit your profile within 60 days.
                                            Steps to follow in order to apply for PR via Express Entry:
                                        </p>
                                        <p class="p-express"><b>5. Complete the Entry Profile form. </b></p>
                                        <p class="p-express">This is the first step in entering the pool to submit a file if you wish to relocate to Canada as a skilled worker. You will be
                                            evaluated in this based on a number of variables. It is not a guarantee that completing the entry profile will result in an
                                            invitation for permanent residency. identity.
                                        ...
                                        <br>
                                        <p class="p-express"><b>1. Complete the online PR application form. </b></p>
                                        <p class="p-express">The majority of applicants submit their applications via consultants specializing in Canada express entry visas from indowest or via
                                            an official Canadian website that includes the National Occupational Classification (NOC). In the event that you have any technical
                                            difficulties when completing it, there might be further options.
                                        </p>
                                        <p class="p-express"><b>Examine the files and add them. </b></p>
                                        <p class="p-express">Fill out the online form with the necessary documents. A few of the foundational documents are enumerated below: -
                                        </p>
                                        <ul class="ani-ul">
                                            <li>Travel document or passport</li>
                                            <li> Medical certifications and police verification</li>
                                            <li> Medical certifications and police verification</li>
                                            <li> Qualification transcripts</li>
                                            <li> certificates proving your marriage, if you are married, or other documents such as divorce, adoption, etc.</li>
                                            <li> a formal job offer from an approved employer</li>
                                            <li>Evidence of finances</li>
                                            <li> or any more files you think the application needs.</li>
                                        </ul>
                                        ...
                                        <h4 class="">3. Submit an application and pay the fees.</h4>
                                        <p class="p-express">You must pay online processing fees (such as PR fees, biometric fees, processing fees for family members, and others) after
                                            submitting the documents.
                                            The processing fee ($850) and the right of permanent residency fee ($515) are the approximate costs associated with your
                                            application. You can visit the official website for the rest.
                                        </p>
                                        <h4 class="">4. Verify the status of your application after submitting it.</h4>
                                        <p class="p-express">Once you've applied, confirm that you meet all the requirements, including those for all the paperwork. Following the processing of
                                            your application, representatives will contact you with updates, take your picture and fingerprints, request more documentation if
                                            needed, schedule an interview, and inform you of the next steps. Should you be proven to be dishonest, your application can be
                                            denied.
                                        </p>
                                        <h4 class="">What happens if your application is accepted?</h4>
                                        <p class="p-express">If your application gets approved, then you will get a mail COPR (Confirmation of Permanent Residence) and PR Visa. This will
                                            include your picture and basic information about you. First, let's make sure the provided information is accurate and put it to use
                                            before it runs out. You can confirm your permanent residence status through the portal. This is to verify that you are in fact in
                                            Canada, that your email is valid, etc. Give the Western abroad team a call or send them a mail to learn more; they will be pleased
                                            to help.
                                        </p>
                                    </div>
                                </div>
