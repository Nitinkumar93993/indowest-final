            ...
            <div class="row">
                            ...
                            <div class="inhouse-heading-tit">
                                <div class="section-title">
                                    <div class="title-header">
                                        <h2 class="inhouse-course-heading">Assessment & Eligiblity Tools</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12 col-lg-12 col-md-7 col-sm-7 col-xs-8 mx-auto">
                    <div class="faq-wrapp">
                        ...
                        <div class="acer">
                            <button class="hplinks" onclick="window.location.href = '/study-visa-eliglibity';">Study
                                Visa Eligibility</button>
                            <button class="hplinks" onclick="openCity(event, 'English Language Assessment')" id="aceropen">English Language
                                Assessment</button>
                            <button class="hplinks" onclick="window.location.href = '/CRS-Calculator';">CRS
                                Calculator</button>
                            <button class="hplinks" onclick="window.location.href = '/Score-Converter';">Score
                                Converter</button>
                        </div>

                        <div id="Study Visa Eligibility" class="acercontent">
                                ...
                                <div class="container ">
                                    <div class="layer-content">
                                        <div class="submit-your-basic-heading-tit">
                                            <div class="">
                                                <div class="title-header">
                                                    <h2 class="Submit-Your-Basic-Information">Submit Your Basic
                                                        Information</h2>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class=" col-lg-12 d-flex justify-content-end">
                                            <div class="header_btn mr-20">
                                                <a class="cmt-btn cmt-btn-size-md cmt-btn-shape-round cmt-btn-style-border cmt-btn-color-white submit-modal" id="clear-all-btn-posts" href="">Start</a>
                                            </div>
                                        </div> -->
                                    </div>
                        ...
                        <div id="English Language Assessment" class="acercontent">
                            <section class="three-column-images">
                                <div class="container ">
                                    <div class="layer-content">
                                        <div class="submit-your-basic-heading-tit">
...
<div id="CRS Calculator" class="acercontent">
    <section class="three-column-images">
        <div class="container ">
            <div class="layer-content">
                <div class="submit-your-basic-heading-tit">
...
<div id="Score Converter" class="acercontent">
    <section class="three-column-images">
        <div class="container ">
            <div class="layer-content">
                <div class="submit-your-basic-heading-tit">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <label class="label-heading-modal" for="countryCode">Country
                        Code</label>
...
<!-- <div class="header_btn mr-20 faq-reset-btn">
                                <a class="cmt-btn cmt-btn-size-md cmt-btn-shape-round"
                                    id="clear-all-btn-posts" href="">Reset</a>
                            </div> -->
</div>
</div>
</div>
