                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/FAMILY-SPOUSAL SPONSORSHIP (2).png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">FAMILY / SPOUSAL SPONSORSHIP (AUS)</p>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> FAMILY / SPOUSAL SPONSORSHIP (AUS)</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">FAMILY / SPOUSAL SPONSORSHIP (AUS)</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">FAMILY / SPOUSAL SPONSORSHIP (AUS)</h4>
                                        <p class="p-express">A family visa is a kind of visa that permits citizens or permanent residents of Australia to bring their relatives to live together.
                                            ...
                                            are available. <br><br>
                                            <b> 1. Partner visa: </b> Basically, this visa is for those who are married to Australian nationals, Australian permanent residents, spouses
                                            ...
                                            getting married), spouse, de facto partner, or wedded partner (including same-sex couples).
                                        </p>
                                        <!-- <br> -->
                                        ...
                                        <ul class="ani-ul">
                                            <li>You have to be in a committed and sincere relationship with a citizen of Australia, a permanent resident of Australia, or a
                                                citizen of New Zealand who qualifies</li>
                                        ...
                                        <p class="p-express"> <b>1. Child visa: </b> This visa is for dependent children of Australian permanent residents, citizens, or allowed New Zealand citizens. In
                                        ...
                                        <ul class="ani-ul">
                                            <li>When the application is being processed, outside of Australia</li>
                                            <li>To be eligible to enroll full-time, a student must be under 18, over 18, or under 25, meaning they must be reliant on their parents financially or unable to work because of a disability.
                                            </li>
                                            <li>The youngster needs to have sponsorship from qualified parents</li>
                                            <li> The youngster must fulfill the age requirements mentioned above.</li>
                                        ...
                                        <p class="p-express"> <b> 1. Parent visa: </b> This visa is available to parents of Australian citizens, permitted New Zealand citizens, and permanent residents
                                        ...
                                        <ul class="ani-ul">
                                            ...
                                            <li>Upon arrival in our nation, parents lose their eligibility for the age pension immediately.</li>
                                        ...
                                        <ul class="ani-ul">
                                            <li>You need a guarantee of assistance. (It guarantees the candidate doesn't depend on the state)</li>
                                            ...
                                            <li>Await the results of the visa application process after completing it.
                                            </li>
                                        </ul>
                                        ...
                                        <p class="p-express">
                                            1. Establish eligibility: Based on your relationship with the family member in Australia, you must first decide which family visa


                                        </p>
                                        <p class="p-express">
                                            2. Send in an expression of interest: The applicant might have to send in an expression of interest to the Department of Home Affairs,
                                            depending on the kind of family visa.

                                        </p>
                                        <p class="p-express">

                                            3. Await invitation to apply: If submitting an expression of interest, the candidate will have to hold off on applying for a visa
                                        ...
                                        <p class="p-express">
                                            ...
                                            4. Submit the necessary paperwork: The applicant must submit the necessary paperwork to back up their application, including
                                        ...
                                        <p class="p-express">
                                            5. Pay application fees: The majority of visa applications call for the payment of an application fee, which varies based on the
                                            applicant's circumstances and the type of visa requested.


                                        </p>
                                        <p class="p-express">
                                            6. Attend interviews (if necessary): The applicant and their Australian family member(s) may be asked to attend an interview,
                                            contingent on the type of family visa.

                                        </p>
                                        <p class="p-express">
                                            7. Await the outcome: After reviewing the application, the Department of Home Affairs will issue the visa if all the requirements
                                        ...
                                        <p class="p-express">
                                            ...
                                            It's crucial to remember that the procedures listed above are merely meant to serve as a general reference. The requirements and
