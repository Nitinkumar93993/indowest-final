                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/FAMILY-SPOUSAL-SPONSORSHIP.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">FAMILY / SPOUSAL SPONSORSHIP</p>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> FAMILY / SPOUSAL SPONSORSHIP</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">FAMILY / SPOUSAL SPONSORSHIP</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">FAMILY / SPOUSAL SPONSORSHIP</h4>
                                        <p class="p-express">A family visa is a kind of visa that permits citizens or permanent residents of Australia to bring their relatives to live together.
                                            Additionally, under some restrictions, it permits citizens of New Zealand to immigrate to this nation. A range of subclasses of
                                            family visas are accessible, including partner, parent, child, and other family visas. For every subclass, there are different
                                            requirements and qualifying criteria for Australian family sponsored visas. The Australian government provides a range of family
                                            visa choices for anyone with relatives living in the nation. Below is a list of the various types of Australian family visas that
                                            are available. <br><br>
                                            1. Partner visa: Basically, this visa is for those who are married to Australian nationals, Australian permanent residents, spouses
                                            or fiances of Australian citizens, or suitable citizens of New Zealand. This visa also falls under two more subcategories: partner
                                            visa (temporary) and partner visa (permanent). Furthermore, as complex cases can occasionally take longer to complete, verify the
                                            application's processing schedule by often visiting the official Australian website. It encompasses a fiancée (with the intention of
                                            getting married), spouse, de facto partner, or wedded partner (including same-sex couples).</p>
                                        <!-- <br> -->


                                        <!-- <br> -->

                                        <h4 class="">Visa sponsored by family Qualifications for eligibility</h4>
                                        <p class="p-express">You need to fulfill the following requirements in order to be qualified for an Australian partner visa:
                                        </p>
                                        <ul class="ani-ul">
                                            <li>Both you and your partner must be at least eighteen years old when you apply.</li>
                                            <li>You have to meet the requirements for character and health.</li>
                                            <li>You and your partner must be able to sponsor each other and meet specific income standards in order for you to meet the financial
                                                requirements.</li>
                                            <li>You must have a valid visa that enables you to apply for another visa while you are in Australia if you are applying from within
                                                the country.</li>
                                        </ul>
                                        <h4 class="">Child visa: </h4>
                                        <p class="p-express">This visa is for dependent children of Australian permanent residents, citizens, or allowed New Zealand citizens. In
                                            general, it is issued under several subclasses alike parent visas. With this visa, the child can stay or work in Australia and also
                                            in public healthcare schemes. This visa provides a travel facility for traveling to and from Australian Country (for five years).
                                            The child needs to be:
                                        </p>
                                        <ul class="ani-ul">
                                            <li>The youngster needs to have sponsorship from qualified parents.
                                            </li>
                                            <li> The youngster must fulfill the age requirements mentioned above.
                                            </li>
                                            <li>He or she cannot be engaged or married.</li>
                                            <li> Must fulfill requirements for character and health.</li>
                                        </ul>
                                        <p class="p-express">1. Parent visa: This visa is available to parents of Australian citizens, permitted New Zealand citizens, and permanent residents
                                            (PR) of Australia. Western countries place particular attention on this kind of visa because many immigrants use it as their parent
                                            visa to enter Australia.
                                        </p>


                                        <ul class="ani-ul">
                                            <li>Parents need to show up for the "balance family test"</li>
                                            <li>Upon arrival in our nation, parents lose their eligibility for the age pension immediately.
                                            </li>
                                            <li>Australians with parent visas are permitted to live there permanently.
                                            </li>
                                            <li>They have permission to work in the nation.</li>
                                            <li> Guarantee social and medical benefits</li>
                                        </ul>
                                        <p class="p-express">1. additional family visas: This type of visa is available to additional eligible family members, including grandparents, parents,
                                            brothers, and sisters. The caregivers can also immigrate to Australia, initially with a temporary visa that can subsequently be
                                            converted to a permanent one.
                                        </p>
                                        <h4 class="">Qualifications for granting this additional family visa:</h4>

                                        <ul class="ani-ul">
                                            <li>You have a legitimate sponsor, such as a sibling, stepparent, eligible parent, stepsibling, or a relative's eligible partner.</li>
                                            <li> You need a guarantee of assistance. (It guarantees the candidate doesn't depend on the state)
                                            </li>
                                            <li>Passport and fulfillment of character and health criteria are prerequisites.</li>
                                            <li>Compile all the required paperwork before submitting your application for a visa.</li>
                                            <li>Await the results of the visa application process after completing it.</li>
                                        </ul>
                                        <p class="p-express">Every type of visa has unique prerequisites and qualifying standards. Before applying, it's crucial to thoroughly weigh your
                                            alternatives for a visa and get expert assistance. Each family visa alternative and the application procedure are covered in full by
                                            the Indowest family visa specialist in Australia.
                                        </p>

                                        <h4 class="">What is the standard procedure in Australia for obtaining a family visa?</h4>
                                        <p class="p-express">Depending on the type of visa and the unique circumstances of the applicant and their family member(s), the application process for
                                            an Australian family visa may differ. The general steps involved are as follows:
                                        </p>
                                        <p class="p-express"> <b>1. Establish eligibility:</b> Based on your relationship with the family member in Australia, you must first decide which family visa


                                        </p>
                                        <p class="p-express"> <b>2. Send in an expression of interest:</b> The applicant might have to send in an expression of interest to the Department of Home Affairs,
                                            depending on the kind of family visa.


                                        </p>
                                        <p class="p-express"> <b>
                                                3. Await invitation to apply:</b> If submitting an expression of interest, the candidate will have to hold off on applying for a visa
                                            until they receive an invitation. On the other hand, some family visas enable the applicant to apply for a visa right away.


                                        </p>
                                        <p class="p-express"> <b>
                                                4. Submit the necessary paperwork:</b> The applicant must submit the necessary paperwork to back up their application, including
                                            identification documents, character and health evaluations, and proof of relationship, among other things.
                                            category applies to you.

                                        </p>
                                        <p class="p-express"> <b>
                                                5. Pay application fees:</b> The majority of visa applications call for the payment of an application fee, which varies based on the
                                            applicant's circumstances and the type of visa requested.



                                        </p>
                                        <p class="p-express"> <b>6. Attend interviews (if necessary):</b> The applicant and their Australian family member(s) may be asked to attend an interview,
                                            contingent on the type of family visa.

                                        </p>
                                        <p class="p-express"> <b>7. Await the outcome:</b> After reviewing the application, the Department of Home Affairs will issue the visa if all the requirements
                                            are met. This process can take anywhere from a few months to over a year, depending on the visa category and processing times.

                                        </p>


                                        <p class="p-express">It's crucial to remember that the procedures listed above are merely meant to serve as a general reference. The requirements and
                                            application process for a family visa may change based on the applicant's and their family member(s)' particular circumstances. The
                                            price of a family visa varies according on the type of visa you're requesting. The price could range from AUD 370 to AUD $6,490. At
                                            indowest, we thoroughly review every document before processing an application and guarantee the greatest outcomes.Nevertheless,
                                            the majority of family visas require you to pay the application fee in two payments; that is, you are not needed to pay the entire
                                            amount at the time of your original application. Visas for family and relatives are presently being processed for a number of years.
                                            Processing time for family and relative visas is faster than for other categories. Get in contact with us to learn more about family
                                            visas and to request more help if you wish to apply for an Australian family sponsored visa.
