                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/INVESTOR-ENTREPRENEUR-VISA.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">INVESTOR / ENTREPRENEUR VISA</p>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> INVESTOR / ENTREPRENEUR VISA</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">INVESTOR / ENTREPRENEUR VISA</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">Discover Pathways of Getting PR Through Investor VISA & Entrepreneur Visa </h4>
                                        <p class="p-express">Canada is a paradise place for investors and entrepreneurs where individuals can dive into the pool of the business world with
                                            tremendous investments and trading opportunities. It is considered one of the top 10 easiest countries to set up and start a
                                            business. The country's prosperous natural resources, availability of skilled labour, and stable and smooth governance all provide a
                                            significant thrust in starting a business in the nation. <br> <br>

                                            IRCC offers brilliant business immigration pathways to people who want to try their luck in the market with their expert skills and
                                            fantastic experience. People with business/administrative experience and relatively high net worth may apply for a Canadian
                                            permanent residence under the Investor/Entrepreneur Visa program. If you are successful with your business immigration application,
                                            you and your family can move to Canada together. Today we are presenting an overview of applying for an Investor VISA & entrepreneur
                                            visa. Let's jump into key points and explore your options to stay in the country forever.</p>
                                        <!-- <br> -->
                                        <h4 class="">The Quebec Immigrant Investor Initiative </h4>
                                        <p class="p-express">Under the Quebec Economic Class selection program grid, candidates qualifying for the Quebec Immigrant Investor scheme are assigned points based on a variety of criteria. The needed minimum score is 40, with cutoffs of 10 and 25 points for managerial experience and

                                            investment of money, correspondingly. The primary variables used for evaluation are
                                        </p>

                                        <ul class="ani-ul">
                                            <li>Field of study or training</li>
                                            <li>Practical management experience</li>
                                            <li>Age</li>
                                            <li>Proficiency in English</li>
                                            <li>Length of stay in Quebec</li>
                                            <li>A contract for investments</li>

                                        </ul>
                                        </h4 class="p">The advantages that an investor visa provides are
                                        </h4>
                                        <ul class="ani-ul">
                                            <li> No hazardous investment promises a complete return after five years of CAD $1,200,000 investment.</li>
                                            <li>After investing, there is no requirement for further involvement.</li>
                                            <li>During or after the application procedure, family members have the same status as the primary applicant.</li>
                                            <li> You are eligible for all of the benefits offered to Canadians while holding an investor visa.</li>

                                        </ul>
                                        <h4 class="">Advantages that the investor visa provides are
                                        </h4>
                                        <ul class="ani-ul">
                                            <li> After five years of investing CAD $1,200,000, no risky investment promises a complete return.</li>
                                            <li>After investing, no more action is required.</li>
                                            <li>Family members who apply during or after the main applicant's process have the same status.</li>
                                            <li>All of the advantages offered to Canadians are yours with an investor visa.</li>

                                        </ul>
                                        <!-- <br> -->

                                        <h4 class="">The Barest Minimum Need to Apply for the Procedure </h4>


                                        <p class="p-express">Minimum net worth: Applicants may get a minimum net worth of CAD $2000,000 or assets of equal value, such as shares, real estate,
                                            bank accounts, pensions, and properties.
                                            Experience: Candidates must have two years of experience, which must have been completed five years prior to application.
                                            Maximum investment: CAN $1,2000,000 may be made by applicants; this amount may be financed by a financial intermediary that has been
                                            approved.
                                        </p>
                                        <h4 class="">Process for QIIP Application Steps</h4>
                                        <ul class="ani-ul">
                                            <li> Submit the application that the Quebec Immigration VISA office has received and accessed.</li>
                                            <li>Applicants may be waived off or scheduled for a personal interview.
                                            </li>
                                            <li> After that, applicants must wire the money</li>
                                            <li>The application is sent to the IRCC office following the transaction.</li>
                                            <li> The medical examination instructions are sent by the embassy.</li>
                                            <li>Passports must be sent in for stamping, and PR application fees must be paid.</li>

                                        </ul>

                                        <h4 class="">Passports must be sent in for stamping, and PR application fees must be paid.</h4>
                                        <p class="p-express">Canada Immigration's Entrepreneur Visa Program!
                                        </p>

                                        <h4 class="">Federal Start-up Visa Program</h4>
                                        <p class="p-express">This program motivates immigrant business people to expand their enterprises in Canada. Prosperous applicants connect with private
                                            sector associations in the country to get funding, guidance, and expertise in beginning and running their enterprises in Canada.
                                            This initiative has been set to target entrepreneurs with the potential to make innovative companies that can compete globally and
                                            generate jobs.
                                        </p>
                                        <h4 class="">Quebec Entrepreneur Program</h4>
                                        <p class="p-express">This Canadian immigration category was invented to let qualified business owners and managers obtain Canadian PR, provided they can
                                            progressively develop or acquire an agricultural, commercial, or industrial business in the Quebec province.

                                        </p>
                                        <h4 class="">Provincial Entrepreneur Programs</h4>
                                        <p class="p-express">Canada's provinces propose hefty entrepreneur categories within their Provincial Nominee Programs. Through one of these categories,
                                            immigrant entrepreneurs can stay in a particular province.
                                        </p>

                                        <h4 class="">For whom is the program appropriate? </h4>

                                        <ul class="ani-ul">
                                            <li>Needed to establish a business that meets certain requirements.</li>
                                            <li> A letter of support from a named organization is required.</li>
                                            <li>Must be proficient in both French and English.</li>
                                            <li>Need sufficient money to establish oneself in the nation.</li>


                                        </ul>
                                        <h4 class="">Steps involved in Applying for the Entrepreneur Visa</h4>

                                        <ul class="ani-ul">
                                            <li>The first step involves making an account at the online portal of the Permanent residence applications. Applicants may take help
                                                from the Instruction Guide (IMM 5759) to complete the form correctly. It is mandatory to upload all supporting documents to
                                                minimize the chance of application rejection.</li>



                                        </ul>
                                        <h4 class="">Additionally, the following forms must be completed electronically</h4>
                                        ...
                                        <ul class="ani-ul">
                                            <p class="p-express">1. Canada's Generic Application Form (IMM 0008)


                                            </p>
                                            <p class="p-express">2. Background/Declaration, Schedule A (IMM 5669)


                                            </p>
                                            <p class="p-express">3. Supplementary Family Data (IMM 5406)


                                            </p>
                                            <p class="p-express">
                                                4. Additional Details - Your Route (IMM 5562)



                                            </p>
                                            <li>Once the application form is completed, it is time to pay the application fees for processing the immigration request,
                                                biometric,
                                                RPRF (Right of Permanent Residence Fee), and third party (if applicable). Third-party fees include the medical exam, police
                                                certificate, or language testing expenses. An online payment mode is provided to make all the transactions.
                                            </li>
                                            <li>After making the necessary fee payments, submit the application and watch for the outcome. The IRCC will issue you a PR visa
                                                together with COPE (Confirmation of Permanent Residence (RPRF)) if your request is granted.
                                                The application process for an entrepreneur visa costs CAN $2,140, and it takes about 30 months to complete, including the
                                                biometrics phase.</li>
                                            <li>After making the necessary fee payments, submit the application and watch for the outcome. The IRCC will issue you a PR
                                                visa together with COPE (Confirmation of Permanent Residence (RPRF)) if your request is granted.
                                                The application process for an entrepreneur visa costs CAN $2,140, and it takes about 30 months to complete, including the
                                                biometrics phase.</li>
