...
<div class="site-main">
    ...
    <div class="">
        <div class="slideshowContainer">
            ...
            <img class="imageSlides img-fluid" src="/images/client/slid-banner-1.png" alt="beach side city view">
            <!-- <img class="imageSlides img-fluid" src="/images/client/slid-banner-2.png" alt="beach side city view"> -->
            <!-- <img class="imageSlides img-fluid" src="/images/client/slid-banner-3.png" alt="beach side city view"> -->
    ...
    <div class="container indowestca-banner-form">
        <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6 mt-10">
                                    <label for="formGroupExampleInput" class="form-label Indo-West-ca-label-text">First Name</label>
                                    <input type="text" class="form-control" placeholder="Enter your first name" aria-label="Enter Your First name" required>
                                </div>

                                <div class="col-md-6 mt-10">
                                    <label for="formGroupExampleInput" class="form-label Indo-West-ca-label-text">Last Name</label>
                                    <input type="text" class="form-control" placeholder="Enter your last name" aria-label="Enter your last name" required>
                                </div>


                                <div class="col-md-6 mt-10">
                                    <label for="formGroupExampleInput" class="form-label Indo-West-ca-label-text">Countery
                                        Code</label>
                                ...
                                <div class="col-md-6 mt-10">
                                    <label for="formGroupExampleInput" class="form-label Indo-West-ca-label-text">Phone Number</label>
                                    <input type="number" class="form-control" placeholder="Enter your mobile no." aria-label="Phone" required>
                                </div>


                                <div class="col-md-6 mt-10">
                                    <label for="inputEmail4" class="form-label Indo-West-ca-label-text">Email</label>
                                    <input type="email" class="form-control" id="inputEmail4 " placeholder="Enter your email" aria-label="ram@gmail.com" required>
                                </div>


                                <div class="col-md-6 mt-10">
                                    <label for="inputdate" class="form-label Indo-West-ca-label-text">DOB</label>
                                    <input type="date" class="form-control" id="inputEmail4 " placeholder="email" aria-label="ram@gmail.com" required>
                                </div>


                                <div class="col-md-12 mt-10">
                                    <label for="formGroupExampleInput" class="form-label Indo-West-ca-label-text">Services</label>
                                ...
                                <div class="col-md-12">
                                    <label class="form-label Indo-West-ca-label-text">Message</label>
                                    <span class="text-input"><textarea name="message" rows="1" maxlength="50" placeholder="Message" required="required"></textarea></span>
                                ...
                                <div class="col-md-12 mt-20">
                                    <button class=" float-right submit cmt-btn cmt-btn-size-md cmt-btn-shape-rounded cmt-btn-style-fill cmt-btn-color-skincolor" type="submit">Send</button>
                                </div>
                                </p>
                            </div>
                        </div>
    ...
    <div class="container-fluid indowest-ca-logo">
        <div class="container d-flex justify-content-center">
            <img src="/images/cropped-2.png" alt="" class="img-fluid indowest-logo-ca-page">
        </div>
    </div>
    ...
    <div class="container-fluid visasection-ca">
        <div class="container visa-imm">
            <div class="row  visa-row">
                <div class="col-md-12 section-one-visa">
                    <div class="row">
                        <div class="col-md-6 d-flex justify-content-start">
                            <div class="mt-auto mb-auto">
                                ...
                                <p class=" mt-auto mb-auto">
                                    <a href="" class="herf"><button type="button" class="btn btn-secondary btn-ji ">Study
                                            visa</button></a>

                                    <a href="" class="herf me-2 ms-2"><button type="button" class="btn btn-secondary btn-ji">Post
                                            study
                                            visa</button>
                                    </a>

                                    <a href="" class="herf"><button type="button" class="btn btn-secondary btn-ji " id="aqn">After Visa
                                            service</button>
                                    </a>
                                </p>
                            </div>
            ...
            <div class="row  visa-row mt-5">
                    ...
                    <div class="row">
                        <div class="col-md-6 d-flex justify-content-start">
                            <div class="mt-auto mb-auto">
                                ...
                                <p class=" mt-auto mb-auto">
                                    <a href="" class="herf"><button type="button" class="btn btn-secondary btn-ji">IELTS</button>
                                    </a>
                                    <a href="" class="herf me-2 ms-2"><button type="button" class="btn btn-secondary btn-ji">PTE</button>
                                    </a>
                                    <a href="" class="herf"><button type="button" class="btn btn-secondary btn-ji" id="">DUOLINGO</button>
                                    </a>
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-12 " style="padding-left: 50px; padding-right: 50px;">
                    ...
                    <a href="" class="herf"><button type="button" class="btn btn-secondary click-btn  mb-3" id="aqn">Click
        ...
        <div class="nitin-book">
                ...
                <div class="col-4">
                    <div class="card" style="width: 370px; height: 100%;">
                        <div class="card-body mt-3">
                            ...
                            <div class="card-text">
                                <div class="text1-heading2 d-flex align-items-center ms-1 mt-0"><i class="bi bi-calendar-check"></i> <span class="branch-any">Date: Jan 31,
                                        2024</span>
                                </div>
                            </div>
            ...
            <div class="Indo-West-ca-load-more">
                <div class="header_btn mr-20">
                    <a class="cmt-btn cmt-btn-size-md cmt-btn-shape-round" id="become-a-member-1" href="">&nbsp;&nbsp;Load More &nbsp;&nbsp;</a>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-3 top-2 text-center">
                    <div class="card car-ji  d-flex pt-3 pb-3 " style="width: 70%;">
                        <p class="text-center">
                            <img src="images/client/slid-banner-second-section-1.png" class="card-img-top img-top-2" alt="...">
                        </p>
