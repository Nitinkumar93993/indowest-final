                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/189-INVITATION-ROUND.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">189
                                        INVITATION ROUND</p>
                                </div>
                            </div>
                        </aside>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6 mt-15">
                                            ...
                                            <select style="padding: 8px 8px 8px 8px;" class="form-select " aria-label="Default select example" required>
                                                <option data-countryCode="IN" value="91" Selected>India
                                                    (+91)
                                                </option>
                                        ...
                                        <div class="col-md-6 mt-15">
                                            <label for="formGroupExampleInput" class="form-label">Phone
                                                Number</label>
                                            <input type="number" class="form-control" placeholder="+91" aria-label="Phone" required>
                                        </div>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> 189 INVITATION ROUND</h4> -->
                            <div class="cmt-service-description">

                                <div class>
                                    <h4 class="about-express-heading">189
                                        INVITATION ROUND</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class>189 INVITATION
                                            ROUND</h4>
                                        <p class="p-express">As per a new update from the Department of Home Affairs, The Skilled Independent (subclass 189) (New Zealand stream only) visa is
                                            permanently closed to new applications on 1st July 2023."

                                            The direct PR scheme known as Skilled Visa Subclass 189 uses a points-based system to invite suitably qualified professionals to
                                            Australia. Employees who are not sponsored by a family member, employer, or Australian territory are eligible for this visa.
                                            Additionally, it entitles you to live and work in Australia, apply for PR or citizenship, and use public healthcare services there.
                                            To A candidate must receive at least 65 points on the skill assessment in order to apply for this subclass 189 visa. First, a person
                                            must submit an Expression of Interest (EOI) and wait for Skillselect to extend an invitation. You have sixty days after receiving an
                                            ITA to submit an application. The Department of Home Affairs holds a cyclical subclass 189 invitation round once a year for skilled
                                            independent visas.
                                            The quantity of invites sent out is determined by the amount of applications and is based on government priorities. Learn more about
                                            the advantages, how to apply, and how long it takes to get a subclass 189 skilled visa for Australia by reading the information below</p>
                                        <!-- <br> -->

                                        <!-- <br> -->

                                        <h4 class>What are the advantages of obtaining a visa under class 189?</h4>
                                        <ul class="ani-ul">
                                            <li> Have permanent residency in Australia for the remainder of your life.
                                            </li>
                                            <li>Job stability and flexibility</li>
                                            <li> Availability of study programs</li>
                                            <li> Rights of Travel</li>
                                            <li>Benefit from security</li>
                                            <li>Medicare accessibility</li>
                                            <li>The procedure for requesting citizenship</li>
                                            <li>Offer your kin or relative a sponsorship</li>

                                        </ul>
                                        <h4 class>How does the subclass 189 Skilled Independent visa operate?</h4>
                                        <ul class="ani-ul">
                                            <li> Schedule a consultation. <br>
                                                Speaking with one of the top immigration consultants and going over your profile is the first step. Whether your goal is to study,
                                                work, or immigrate permanently or temporarily to Australia, our team of qualified agents and immigration lawyers at Indowest will
                                                assist you with every step of the visa application process.
                                            </li>
                                            <li>Check your occupation on the skilled list <br>
                                                Depending on your occupation and assessment authority requirements, You need at least 2 years of work experience for a skilled
                                                Independent visa. So, the second important step is to find your occupation on the skill list.
                                            </li>
                                            <li>Determine your point total. <br>
                                                To apply for a skilled visa, an applicant must receive at least 65+ points in the competence exam. Visit our closest branch to
                                                discover the finest options if you need help with point calculations and how to enhance your skill assessment. Determining the
                                                results may require some time from the assessment authority.</li>
                                            <li> Lodge Expression of Interest with Department <br>
                                                If you score 65+ on the skill assessment, then you can lodge an EOI (Expression of Interest) for skilled independent visas. As you
                                                fill in the information in the EOI, you will get points on the criteria of personal details such as age, education, english skills,
                                                experience, partner skills, etc.</li>
                                            <li> Wait for an ITA <br>
                                                After submitting an EOI, wait for ITA from the Department of home affairs. Once you receive an ITA, you can submit a visa fee to
                                                lodge your visa application. You must wait for 189 visa invitation rounds as per the number of applications. Receiving an ITA is a
                                                positive sign towards applying for visa subclass 189 Australia.
                                            </li>
                                            <li>Get a visa and relocate to Australia. <br>
                                                It is the final stage that takes a great deal of endurance. You can start packing for your trip to Australia as soon as you have your
                                                visa. The ability to immigrate permanently to Australia is the best feature of this visa.</li>

                                        </ul>
                                        <h4 class>How can Indowest help you? </h4>
                                        <p class="p-express"> Applying for a visa is an extensive process, and we at Indowest help you in various aspects step by step. We have
                                            experienced and certified counselors to assist you in visa processes for almost all countries. It's just like you name it, and we do
                                            it. Here are some services from our list are mentioned below:-</p>
                                        <ul class="ani-ul">
                                            <li>Free counseling. Book your slot today!</li>
                                            <li>Coaching for English proficiency tests like IELTS, PTE, TOEFL, etc.</li>
                                            <li>Complete guidance for all types of visa services</li>
                                            <li>Eligibility check and skill assessment</li>
                                            <li> Provide assistance and support in gathering documents</li>
                                            <li> Certified immigration lawyers in Australia to help you with post-landing services.
                                            </li>
                                        </ul>
