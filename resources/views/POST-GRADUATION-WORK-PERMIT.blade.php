                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/POST-GRADUATION-WORK-PERMIT.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">POST GRADUATION WORK PERMIT</p>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> POST GRADUATION WORK PERMIT</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">POST GRADUATION WORK PERMIT</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">Extension of Study Permit: Advantages IRCC Offers Students for Additional Education</h4>
                                        <p class="p-express">Extensive study programs across all industries, along with excellent educational standards and a high level of living, provide ample
                                            motivation for students to continue their studies in the nation long after they have graduated. Aspirants seeking a broad window of
                                            opportunity to pursue high-quality courses in the hopes of a successful career are always welcome at IRCC. The best method to get
                                            into a new program at a university without having to leave the country and reapply for a study visa is to apply for a study permit
                                            extension. Your study permit is automatically renewed and extended for the length of your new program. the immigration authority to
                                            apply for the application within Canada. Let's jump into the topic.
                                            Can study permit be extended in Canada? The answer is a big yes! It is a boon for international
                                            students on a student visa who wish to study further after completing their current course and want to stay in the country.
                                        </p>
                                        <!-- <br> -->

                                        <h4 class="">When Should My Canadian Study Permit Be Renewed?</h4>
                                        <p class="p-express">The research permit's expiration date indicates when to submit an application for an extension. The date also indicates when you
                                            ought to quit your studies and depart the country. It is inscribed on the study permit in the upper right corner. Typically, a
                                            student visa's term corresponds to the length of the course they plan to take. Students are also granted an extra ninety days to
                                            finalize their plans, which may include departing the nation or enrolling in an alternative degree. These three months are extremely
                                            important and should not be wasted.
                                            Use the advice below to ensure a seamless transition if you intend to enroll in a new course in the country.
                                        </p>
                                        <ul class="ani-ul">

                                            <li>Students must apply for the application within 30 days before the expiry date of their student visa.</li>
                                            <li> How to extend Study Permit in Canada online is the most commonly asked question that will be further discussed in detail.</li>
                                            <li> If your visa expires, and you still like to stay there, you must apply for a new study permit or restore your status as a
                                                transient resident.
                                            </li>
                                        ...
                                        <ul class="ani-ul">
                                            ...
                                            <li> The early application enables you to study under the same terms and conditions until you get the decision from the embassy.
                                            </li>
                                        </ul>

                                        <h4 class="">A Comprehensive Procedure to Prolong a Study Permit in Canada</h4>
                                        <p class="p-express">It is advised by the IRCC to apply for the extension online. It also occurs in most circumstances, unless you have a disability.

                                            It prevents you from submitting the application online and causes a problem with the online request for the extension.
                                        ...
                                        <ul class="ani-ul">
                                            ...
                                            <li> It guarantees that your application is finished before submitting it.</li>
                                        ...
                                        <ul class="ani-ul">
                                            <li>A letter of enrollment and transcript from CELD (exclusively for ELIP candidates and grads); enrollment verification from ask.
                                                uwindsor.ca and transcript via the UWinsite Student Portal</li>
                                            <li>Letter of Acceptance (LOA) (if your academic course hasn't started yet)</li>
                                            <li>A letter of cooperation (if requesting a cooperative work permit concurrently)
                                            </li>
                                            <li>f relevant, transcripts from other Canadian organizations</li>
                                            <li>Your passport, valid for the duration of the upcoming course; • A previous, valid study permit; • The most recent passport-size
                                                photos of Canada</li>
                                            ...
                                            <li>Documentation proving tuition and lodging costs were paid</li>
                                            ...
                                            <li> Proof that the grant was made in Canada if you receive financial aid for a scholarship
                                                If necessary, a report on the medical examination
                                            </li>
                                            <li>If required, a letter of explanation</li>
                                        </ul>


                                        <h4 class="">Examine Costs of Permit Extensions</h>
                                            <p class="p-express">
                                                $150 is the application price (including the extension). CAN is the biometric charge. $85.

                                            </p>

                                            <h4 class="">Processing Time For Extension of Study Permit for Canada</h>
                                                <p class="p-express">
                                                    </b> Step 4: </b>It takes about 118 working days to complete the online application, whereas it takes about 113 days to complete the paper version.
                                                    The biometric processing time is not included in this processing window.
                                                </p>
