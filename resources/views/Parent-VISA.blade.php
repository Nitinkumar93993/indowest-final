                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/PARENT-VISA.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">Parent VISA</p>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            ...
                            <div class="cmt-service-description">
                                ...
                                <div class="">
                                    <h4 class="about-express-heading">Parent VISA</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">Parent VISA</h4>
                                        <p class="p-express">Australia is a stunning nation that provides its citizens with a wide range of necessities for survival. The good fortune of raising
                                            their parents in the nation is available to students who are studying there or who have finished their education and are missing
                                            them. The Australian Department of Home Affairs supports the "parent visa" category of visas in an effort to increase happiness
                                            within its nation. We're here today to educate you all on family visas, including the extensive application procedure, qualifying
                                            requirements, and how we help others who fall into the same group. Thus, why do you delay? Now let's get going!
                                            The borders between Australia and other countries are always open for parents to visit their kids. In addition, there are
                                            requirements that must be met for anyone wishing to join the country. A person may enter the country temporarily or permanently with
                                            one of two parent visa kinds. Let's examine each of them separately.</p>
                                        <!-- <br> -->

                                        <h4 class="">VISA for Parents (Subclass 103)</h4>
                                        <p class="p-express">Under some conditions, this type of visa permits parents to live permanently with their children.
                                        </p>
                                        <ul class="ani-ul">

                                            <li>You need to be the parent of a child who is an Australian citizen by law.
                                            </li>
                                            <li>either a permanent resident of Australia OR a citizen.</li>
                                            <li>You have to abide by Australian law and the requirements of the applied visa</li>
                                            <li>You cannot have used subclass 870 to apply for a parent visa.</li>
                                            <li>Upon granting of the visa, parents are entitled to</li>
                                            <li>Arrive in the state or remain there as a permanent resident</li>
                                            <li>Encourage any member who qualifies to accompany them in the nation.</li>
                                            <li>Apply for citizenship if you meet the requirements</li>
                                            <li>If it interests you, you can work and study here</li>
                                            <li>Savor the advantages of public health care initiatives.</li>

                                        </ul>

                                        <!-- <br> -->

                                        <h4 class="">Who is qualified to sponsor?</h4>
                                        <p class="p-express">To apply for this visa, you must have a sponsor who meets the requirements.
                                            Your eligible children should normally be responsible for providing financial assistance, but if they are minors, then eligible
                                            relatives may be able to sponsor you.
                                            The application is approved by the immigration authority upon receipt of the sponsorship. In addition to the eligibility
                                            requirements listed above, there are a few further requirements that applicants must meet. Let's examine them.

                                        </p>

                                        <p class="p-express">
                                            <b>Balance of family test:</b> If someone is seeking for a parent visa under this category, 103, they must pass the Balance of family test.
                                            You satisfy the test's requirements if

                                        </p>
                                        <p class="p-express">
                                            <b>Assurance of support:</b> The applicants must provide a statement stating that, upon entering the nation, they would not rely on
                                            government assistance. The letter's mailing date will be communicated to you by the immigration department
                                        </p>
                                        <p class="p-express">
                                            <b>Health certificate:</b> When applying for a visa, applicants must provide a current, valid health certificate. Additionally, there are
                                            health standards that must be fulfilled. The goal of this policy is to uphold the nation's health standards
                                        </p>
                                        <p class="p-express">
                                            <b>Character certificate:</b> Only immigrants with good moral character are permitted entry into the nation by immigration authorities. The
                                            certificate attesting to your lack of prior criminal conduct on a social or personal level must be deposited.
                                        </p>

                                        <h4 class="">How to get things started | Step-by-step breakdown</h4>
                                        <p class="p-express">
                                            <b>Step 1: Necessary</b>
                                            Verify that the following documents are available before submitting an application.a valid passport <br><br>
                                            Verification of identity <br><br>
                                            Letter of sponsorship (Form 40) for immigration to Australia <br><br>
                                            Certificate of Balance-of-Family Test <br><br>
                                        </p>
                                        <ul class="ani-ul">
                                            <li>Letter of assurance of support
                                            </li>
                                            <li>Images</li>
                                        ...
                                        <h4 class="">Step 2: Submit an application for the procedure</h4>
                                        <p class="p-express">The candidates must submit a paper application for a parent visa after gathering the required paperwork. "Form 47PA: Application for
                                            a Parent to Migrate to Australia" needs to be filled out. The completed application cannot be turned in in person. Rather, it must
                                            be sent via courier to the Parent Visa Processing Center in Perth, at the location provided on the form, along with the specified
                                            supporting documentation.
                                        </p>
                                        <h4 class="">Step 3: Following the requirement</h4>
                                        <p class="p-express">The immigration authority tells you to wait while the application is processed after receiving it. Even after you submit the
                                            application, the authority may notify you of further tasks that you need to do
                                        </p>
                                        <h4 class="">3. Lorem ipsum dolor sit amet.</h4>
                                        <ul class="ani-ul">

                                            <li>Applying for a parent visa will cost you AUD $6,625 in total. Each additional person traveling with you will incur an additional
                                                charge.</li>
                                            <li>The fees may be paid in two installments by the applicants. When submitting an application for a visa, you can pay the first
                                                installment; the second installment can be paid whenever the immigration office requests it</li>
                                            <li>There is no set time for processing the application; it all relies on how quickly and accurately it is submitted.
                                            </li>
                                        </ul>



                                        <h4 class="">Temporary Sponsored Parent Visa (Subclass 870) </h4>
                                        <p class="p-express">With this visa, you are able to

                                        </p>
                                        <ul class="ani-ul">
                                            <li>Join your kids in the</li>
                                            <li>can remain in the nation for three or five years.
                                            </li>
                                            <li>To extend your stay by up to ten years, reapply for the same visa</li>
                                        </ul>


                                        <h4 class="">Who is qualified? </h4>
                                        <p class="p-express">To be qualified to submit a Sponsored Parent application, you must

                                        </p>
                                        <ul class="ani-ul">
                                            <li>Prior to submitting the application, secure the support of an approved sponsor</li>
                                            <li>Fill up the application by applying online.

                                            </li>
                                            <li>File for your parent's visa before the six-month mark after sponsorship approval.
                                            </li>
                                        </ul>

                                        <h4 class="">Documents checklist </h4>

                                        <ul class="ani-ul">
                                            <li>Valid passport</li>
                                            <li>Identity proof</li>
                                            <li>Permission to Apply in Australia</li>
                                            <li>Character documents</li>
                                        </ul>


                                        <h4 class="">How should one apply? </h4>

                                        <p class="p-express">Within six months of the sponsorship being granted, applicants can apply for the visa online at the official immigration website.
                                            Additionally, there is a waiting period after applying
                                        </p>
                                        <h4 class="">The price and duration of processing </h4>

                                        <p class="p-express">A temporary parent visa costs AUD5,090 for a three-year stay and AUD10,180 for a five-year stay. Just like in the case of the
                                            permanent parent visa, applicants may choose to pay the amount in two installments.
                                            The application processing process takes two to three months. Processing of visas is delayed for numerous additional reasons.
                                        </p>
