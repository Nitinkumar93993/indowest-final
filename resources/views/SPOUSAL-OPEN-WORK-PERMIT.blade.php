                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/SPOUSA-OPEN-WORK-PERMIT.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">SPOUSAL OPEN WORK PERMIT</p>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> SPOUSAL OPEN WORK PERMIT</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">SPOUSAL OPEN WORK PERMIT</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">SPOUSAL OPEN WORK PERMIT</h4>
                                        <p class="p-express">Spousal Open Work Permits (SOWP) are granted by Canada to those who are legally married to Canadian citizens or students. The
                                            qualified applicant may be the primary candidate's Canadian-residing spouse or common-law partner. This common-law spouse or
                                            partner, irrespective of their profession or area of study, is free to live and work anywhere in Canada with few restrictions. A
                                            principle applicant may ask SOWP to sponsor their partner if they are currently awaiting permanent residency status in Canada and
                                            have a valid study permit. A principal applicant needs to be enrolled full-time in one of three types of post-secondary educational
                                            institutions: public, private, college-level, or Canadian private institutions authorized to grant degrees.</p>
                                        <!-- <br> -->

                                        <!-- <br> -->

                                        <h4 class="">prerequisites for a spouse's open work permit </h4>
                                        <ul class="ani-ul">
                                            <li>To be eligible for permanent residence in Canada, the principal applicant must hold a valid work permit or study permit.</li>
                                            <li> The candidate has to be enrolled full-time in one of the following educational institutions.</li>
                                            <li> Publicly funded postsecondary education</li>
                                            <li> In Quebec, private schools are the equivalent of a college.</li>
                                            <li> A university authorized by state legislation to offer degree programs in Canada</li>
                                            <li>In order to be granted entry into Canada, the primary applicant's spouse must fulfill all requirements.</li>
                                            <li> A current passport is required for the Spouse.</li>
                                            <li>At the time of the SOWP (Spousal Open Work permit) application, the principle applicant must be in Canada with a valid status.</li>
                                            <li>Are not prohibited from entering Canada by law or medicine</li>
                                            <li> Extra requirements depend on the SOWP categories you are applying for.</li>

                                        </ul>
                                        <h4 class="">Fee Records for a Temporary Work Permit </h4>
                                        <p class="p-express">The primary applicant's responsibility as a sponsor
                                            Once you are financially able to support your partner, you will need to sign a permission document committing you to meeting the
                                            dependent's basic needs.</p>



                                        <h4 class="">Essential requirements include: </h4>
                                        <ul class="ani-ul">
                                            <li> clothing, food, housing, and other necessities of daily life</li>
                                            <li> medical treatment, including those related to teeth, eyes, and other health conditions not covered by government policy.
                                        ...
                                        <h4 class="">Checklist for spouses' open work permits documents </h4>
                                        <ul class="ani-ul">
                                            <li>Evidence of a spouse's relationship</li>
                                            <li>Valid passport currently in use</li>
                                            <li>The application</li>
                                            <li>Recognition of Receipt</li>
                                            <li>A letter proving the benefits of the labor market from the spouse's employer</li>
                                            <li>CIC-mandated supporting documents</li>

                                        </ul>


                                        <h4 class="">Remit Fees:</h4>
                                        <p class="p-express">The application has a processing cost. Both the biometric and right of permanent residency fees must be paid.</p>
                                        <h4 class="">Send in the application:</h4>
                                        <p class="p-express">The completed form will now be sent with supporting documentation by mail or online portal. Before mailing it, remember to create a
                                            copy for yourself.</p>
                                        <h4 class="">Await the Resolution:</h4>
                                        <p class="p-express">It will take a few weeks to many months to complete this process. You must wait for Immigration's and Citizenship and Refugees
                                            Canada's decision. Almost entirely depends on how long processing takes in your area.</p>




                                        <h4 class="">Students are helped by how to submit their applications online.</h4>
                                        <ul class="ani-ul">
                                            <li> There are no mail delivery delays or courier costs because applications are processed immediately.
                                            </li>
                                            <li>It helps students ensure that, before submitting their application, it is accurate and comprehensive.
                                            </li>
                                            <li> They can expeditiously submit additional documentation via the internet upon embassy request.
                                            </li>
                                            <li> Students are able to quickly check the application status.
                                            </li>

                                        </ul>
                                        <h4 class="">How much time does it take to process an open work permit for a spouse?</h4>
                                        <p class="p-express">How much time does it take to process an open work permit for a spouse?
                                        </p>
                                        <h4 class="">Spouse open work permit fees
                                        </h4>
                                        <p class="p-express">The cost of a spouse sponsorship application is CAN $75. Along with the application charges, there are also the principal applicant
                                            processing fees, which are $490. It costs you CAN $565 to bring your spouse to Canada on a work permit.
                                        </p>
                                        <h4 class="">How long is the Spousal open work permit valid?</h4>
                                        <p class="p-express">A spousal open work permit is valid for as long as the main applicant's permit. You can request an extension permit for your partner'
                                            s stay in Canada when you try for PGWP. But before the existing status expires, they can apply separately. Please ensure that you
                                            include all the appropriate documentation for spouse open work permit extension.
                                        </p>

                                        <h4 class="">Reasons for rejecting spouses' open work visas</h4>
                                        <ul class="ani-ul">
                                            <li><b>Insufficient Supporting documentation: </b> These could be identification or financial documentation, an LMIA (Labour Market Impact
                                                Assessment) approval, or verification of legal immigration status.
                                                reasons for rejecting spouses' open work visas</li>
                                            <li><b> Insufficient supporting documentation: </b> These could be identification or financial documentation, an LMIA (Labor Market Impact
                                                Assessment) approval, or proof of legal immigration status.</li>
                                            <li><b>No qualifying work: </b> If an applicant's anticipated occupation does not meet the requirements for eligibility, their application may
                                                be denied.</li>
                                            <li><b>Unavailable employment: </b> If there are no jobs in Canada that suit an applicant, their application may be rejected at times. The
                                                employment market must be examined by candidates to ascertain whether possibilities appropriate for their field and region exist
                                                before submitting an application for a visa.</li>
                                            <li><b> Issues with inadmissibility: </b> If the applicant has a criminal history or another problem, such health or security concerns. So,
                                                because of these problems, SOWP can be rejected.</li>


                                        </ul>
                                        <h4 class="">I need assistance obtaining a spouse open work permit</h4>
                                        <p class="p-express">The location you should prioritize visiting first is Indowest. We are a reputable company because of our open and sincere approach to
                                            processing the many visa or work permit categories. Our unwavering commitment to giving our clients the best immigration services
                                            possible presents a positive image in the field of international education. Come to our office for the answers to all of your visa
                                            questions.
                                        </p>
                                    </div>
                                </div>
