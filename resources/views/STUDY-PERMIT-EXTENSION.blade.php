                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/STUDY-PERMIT-[EXTENSION].png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">STUDY PERMIT (EXTENSION)</p>
                                </div>
                            </div>
                        </aside>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <!-- 
                                                    ...
                                                    <p class="text-end"><button type="button"
                                                            class="btn btn-danger">Send</button></p> -->
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> STUDY PERMIT (EXTENSION)</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">STUDY PERMIT (EXTENSION)</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">STUDY PERMIT (EXTENSION)</h4>
                                        <p class="p-express"> Advantage The IRCC Offers Students Resources for Additional Study
                                            Elevated living standards, top-notch educational standards, and an abundance of study options
                                            across many fields are sufficient incentives for students to remain in the nation for post-graduat
                                            ion studies. Aspirants seeking a broad window of opportunity to pursue high-quality courses in
                                            the hopes of a successful career are always welcome at IRCC. The best method to get into a new
                                            program at a university without having to leave the country and reapply for a study visa is to
                                            apply for a study permit extension. Your study permit is automatically renewed, extending its
                                            validity for the duration of your new program. Here, we'll talk about the process that the
                                            immigration authorities advises </p>
                                        <!-- <br> -->

                                        <!-- <br> -->

                                        <h4 class="">When Should My Canadian Study Permit Be Renewed?.</h4>
                                        <p class="p-express">The research permit's expiration date indicates when to submit an application for an extension.
                                            It also indicates when you should quit your studies and depart the country. It is inscribed on
                                            the study permit in the upper right corner. Typically, a student visa's term corresponds to the
                                            length of the course they plan to take. Students are also granted an extra ninety days to
                                            finalize their plans, which may include departing the nation or enrolling in an alternative
                                            degree. These three months are extremely important and should not be wasted.
                                        </p>

                                        <p class="p-express">To ensure a seamless study permit extension process if you intend to enroll in a new course in the country,
                                            kindly refer to the criteria listed below.
                                        </p>
                                        <ul class="ani-ul">
                                            <li>The application must be submitted by students no later than 30 days before to the expiration of their student visa.
                                                We will go into more detail on the most frequently requested subject, which is how to extend a study permit in Canada online.</li>
                                            <li>If you would still wish to stay after your visa expires, you will need to reapply for a study permit or regain your status as a
                                                temporary resident.</li>
                                        ...
                                        <h4 class="">Requisite before applying for the visa extension</h4>
                                        <ul class="ani-ul">
                                            <li> Make sure you put in the application 30 days before the expiry date</li>
                                            <li>Your passport must have enough validity till or above the duration of the new program</li>
                                            <li>The early application enables you to study under the same terms and conditions until you get the decision from the embassy.</li>
                                        ...
                                        <h4 class="">A Comprehensive Procedure to Prolong a Study Permit in Canada</h4>
                                        <p class="p-express">It is advised by the IRCC to apply for the extension online. In the majority of cases, it also occurs—unless you have a disability
                                            that prevents you from submitting the application online or there is a problem with the online request for an extension.
                                            Why Using an online application reduces courier costs and delivery time
                                        </p>
                                        <ul class="ani-ul">
                                            <li>In comparison to paper mode, processing time is comparatively fast.</li>
                                            <li>It guarantees that your application is finished before submitting it.
                                            </li>
                                            <li> If the embassy requests more papers, it is a quick and easy method to upload and email them</li>
                                            <li> Through their online account, applicants can quickly monitor the status of their applications</li>
                                        ...
                                        <p class="p-express">
                                            <b>Step 1:</b> Compile all required paperwork. To create scanned copies, you'll need a scanner or camera. You need a credit or debit card
                                            in order to make an online payment.

                                        </p>
                                        <p class="p-express">
                                            <b>Step 2:</b> Go over each instruction carefully. There is a manual available to ensure that the process is completed correctly. It
                                            provides instructions on how to populate each column.

                                        </p>
                                        <p class="p-express">
                                            <b>Step 3:</b> Verify that all of the questions are answered accurately. A customized documents checklist will be generated for you based
                                            on your responses.

                                        </p>
                                        <p class="p-express">
                                            <b>Step 4:</b> Following form completion, you must pay the fees to complete the online application.
                                        </p>
                                        <p class="p-express">
                                            <b>
                                                Step 5: </b>In order to submit the application for a study permit extension, create an online account at the IRCC's official website
                                            (canada.ca/en/immigration-refugees-citizenship/services/application/account.html). You can begin the application process, complete
                                            the form for an extension of your study permit, upload supporting documentation, pay costs, and monitor the status of your
                                            plication.
                                        </p>
                                        <h4 class="">Documents Needed for Canada's Study Permit Extension</h4>

                                        <ul class="ani-ul">

                                            <li>A transcript obtained from the UWinsite Student Portal and an enrollment verification from ask.uwindsor.ca</li>
                                            <li>CELD transcript and enrollment letter (ELIP candidates and grads only)</li>
                                            <li> A letter of cooperation (if requesting a cooperative work permit concurrently)
                                            </li>
                                            <li>If relevant, transcripts from other Canadian organizations</li>
                                            <li>Your passport, valid for the duration of the next course you are enrolled in</li>
                                            <li>A prior, current study permission</li>
                                            <li> Information about your name-brand Canadian bank account</li>
                                            <li>A financial institution loan for education or students</li>
                                            <li>The last four months' worth of bank statements</li>
                                            <li>An exchangeable currency bank draft</li>
                                            <li>Documentation proving tuition and lodging costs were paid
                                            </li>
                                            <li>A letter from the individual or organization making the financial offer.</li>
                                            <li> Proof that the grant was made in Canada if you receive financial aid for a scholarship
                                            </li>
                                            <li> A medical examination report, if necessary</li>
                                            <li> If required, a letter of explanation</li>



                                        </ul>

                                        <h4 class="">Indowest Assistance in Handling Difficulties</h4>
                                        <p class="p-express">
                                            We are a reputable company in the immigration industry, offering high-caliber visa services both inside and outside of Canada. Our
                                            licensed counselor appropriately assists customers in determining the best course of action for obtaining a successful visa. Our
                                            expert assistance made it possible for thousands of applicants to fulfill their goal of studying in Canada. We take on challenging
                                            cases and make every effort to address their complexities. We constantly treat our customers with courtesy to ensure they have the
                                            greatest possible visitation experience because we appreciate their time and money. Come see us and heed our professional advise to
                                            keep informed.
                                        </p>
                                    </div>
                                </div>
