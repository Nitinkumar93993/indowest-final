                ...
                <div class="row">
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span mt_80 pt-80 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-contact express-image">
                            <img class="img-fluid " src="images/mig-canada-ima/SUPER-VISA-VISITOR-VISA.png" alt="single_12">
                            <div class="cmt-col pt-0 pl-0 pr-0 pr-0 pb-0">
                                <div class="layer-content">
                                    <p class="EXPRESS-image-botom-text">SUPER VISA / VISITOR VISA</p>
                                </div>
                            </div>
                        </aside>
                    ...
                    <div class="col-lg-8 content-area">
                        <div class="cmt-service-single-content-area">
                            <!-- <h4> SUPER VISA / VISITOR VISA</h4> -->
                            <div class="cmt-service-description">

                                <div class="">
                                    <h4 class="about-express-heading">SUPER VISA / VISITOR VISA</h4>
                                </div>
                                <div class="cmt-bgcolor-white box-shadow pt-20 pl-30 pb-20 pr-30 mb-30 exn">
                                    <div class="row">
                                        <h4 class="">SUPER VISA / VISITOR VISA</h4>
                                        <p class="p-express">IndoWest Immigration ensures a seamless and successful application process by providing
                                            professional support for acquiring Visitor Visas to Canada. With a thorough understanding of
                                            Canadian immigration laws, their staff offers individualised advice based on the requirements of
                                            each application. To increase the likelihood that the visa will be approved, they assist with
                                            navigating the complicated documentation requirements, guarantee accurate form completion, and
                                            provide interview preparation. IndoWest Immigration's assistance simplifies the process, enabling
                                            people to easily visit Canada for tourism, family vacations, or business purposes. This allows
                                            people to take in the country's attractions, get back in touch with loved ones, or carry out
                                            business. They are a reliable option for people looking to enter Canada with a visitor visa
                                            because of their dedication to quality and customer happiness.</p>
                                        <!-- <br> -->

                                        <!-- <br> -->

                                        <h4 class="">WHAT A VISITOR VISA</h4>
                                        <p class="p-express">The Visitor Visa service offered by IndoWest Immigration makes it easier to go temporarily to
                                            Canada for business, pleasure, or family trips. They expedite the application process,
                                            guaranteeing correctness and compliance with Canadian immigration requirements, by providing
                                            individualized assistance and knowledgeable support. In order to increase the possibility that a
                                            visa will be approved, their staff helps applicants navigate the complexity of documentation,
                                            fills out forms, and gets ready for interviews. Whether people are traveling to Canada for
                                            business, to see its attractions, or to reconnect with friends and family, IndoWest Immigration's
                                            commitment to quality guarantees a simple and hassle-free trip. IndoWest Immigration is the
                                            go-to company for anyone looking for visitor visas since they enable their clients to go to
                                            Canada for short periods of time with confidence and peace of mind by utilising their knowledge
                                            and resources.
                                        </p>
                                        <h4 class="">WHAT IS SUPAR VISA</h4>
                                        <p class="p-express">Families hoping to spend prolonged time together with loved ones in Canada can do so with IndoWest
                                            Immigration's Super Visa service. With this visa, parents and grandparents of citizens and
                                            permanent residents of Canada can visit the country for up to two years at a time without having
                                            to renew their visa. IndoWest Immigration offers professional advice on documentation and
                                            regulations, streamlining the application procedure. Their committed assistance makes sure that
                                            families may easily complete the application process, allowing for relaxed and stress-free
                                            reunions. Families can enjoy long stays together in Canada with IndoWest Immigration's Super Visa
                                            program, creating priceless memories and enduring ties.
                                        </p>

                                        <h4 class="">A tourist visa can be applied for by whom? </h4>
                                        <ul class="ani-ul">
                                            <li>The applicants' passports need to be current.
                                            </li>
                                            <li>Their health needs to be in good shape.</li>
                                            <li> They cannot have a history of fraud pertaining to immigration or a criminal record.
                                            </li>
                                            <li> After six months, they must persuade the visa officer that they have close ties to their native country.
                                            </li>
                                            <li> At the conclusion of your visit, you must be able to reassure the officials regarding the planned departure.</li>
                                            <li> Applicants need to have sufficient money to maintain their national lifestyle.
                                            </li>
                                            <li> Requests for a medical examination and an invitation letter from anyone who currently resides in the nation are also acceptable.</li>
                                        </ul>

                                        <h4 class="">Who can obtain a super visa </h4>
                                        <ul class="ani-ul">
                                            <li>The candidates have to be the parents or grandparents of a Canadian citizen or lawful permanent resident.

                                            </li>
                                            <li>They need to provide a signed letter from their kids stating that they are okay with you being in the nation with them.</li>
                                            <li> the obligation to cover your expenses for the duration of the visit.

                                            </li>
                                            <li> a list of the person's Canadian relatives.

                                            </li>
                                            <li> documentation of permanent residence or citizenship in Canada.</li>
                                            <li> There should be a down payment and either a complete payment or installments.
                                            </li>
                                            <li> It ought to be good for a maximum of a year.</li>
                                            <li>Medical care, emergency hospitalization, and repatriation should all be covered.
                                            </li>
                                            <li>You should have coverage of at least CAN $100,000 from the insurance.</li>
                                            <li>Only those who are not in Canada may apply for a super visa.</li>
                                        </ul>

                                        <h4 class="">WHAT IS SUPAR VISA</h4>

                                        <p class="p-express"> <b>Step 1: Gather the paperwork </b>
                                            The required documentation supporting your visitor visa application eligibility criteria must first be gathered by the interested
                                            individuals.
                                            To obtain the list of required documents for a visitor's visa, go to the IRCC website. The candidates ought to confirm if they must
                                            undergo biometric screening, as it is a mandatory procedure for first-time guests.
                                        </p>
                                        <p class="p-express"> <b>
                                                Step 2: Put in the application online </b>
                                            Go online to create an account at the Canada immigration site, upload documents, and pay the visitor visa application fees.
                                        </p>
                                        <p class="p-express"> <b>Step 3: Go for biometrics </b>
                                            After paying for the application, applicants are told to visit the embassy for biometrics, which includes taking fingerprints and
                                            photos.

                                        </p>
                                        <p class="p-express"> <b>
                                                Step 4: Application under the process </b>
                                            Once you do all the official formalities, the embassy starts evaluating the application, and if they find everything fine,
                                            application gets approved.
                                        </p>
                                        <p class="p-express"> <b>Step 5: Submit the passport (if the embassy accepts your application) </b>
                                            Applicants need to send the passport to the embassy for stamping purposes, and they send back the document with an approved visa.
                                        </p>
                                        <p class="p-express"> <b>
                                                Step 6: Manage your travel </b>
                                            Once you get the visa, make arrangements to travel to the country and enjoy the trip.
                                        </p>


                                        <h4 class="">Procedure for Super VISAs: How to Apply?</h4>
                                        <p class="p-express"> <b>
                                                Procedure for Super VISAs: How to Apply?
                                            </b>
                                        </p>
                                        <ul class="ani-ul">
                                            <li>An invitation letter from your children; </li>
                                            <li>Evidence that your children can assist you financially; </li>
                                        </ul>
                                        <p class="p-express"> <b>1. The most recent tax year's T4/T1 or NOA (Notice of Assessment)

                                        </p>
                                        <p class="p-express"> <b>2. Employment Insurance Benefit Statements

                                        </p>
                                        <p class="p-express"> <b>3. An offer letter outlining the hiring date, work duties, job profile, and salary range

                                        </p>
                                        <p class="p-express"> <b>4. Pay stubs

                                        </p>
                                        <p class="p-express"> <b>5. bank records • Evidence of health insurance

                                        </p>

                                        <p class="p-express"> <b>

                                                Step 2: Submit the application</b>

                                            You can apply for a super visa through the IRCC portal from outside the nation. To create an account, you must fill out the form and
                                            provide the required evidence. Please make the application fee payment and submit the request.

                                        </p>
                                        <p class="p-express"> <b>

                                                Step 3: The processing of the application</b>

                                            The request is approved by the embassy once they have verified everything and examined the application.
                                        </p>
                                        <p class="p-express"> <b>

                                                Step 4: The passport is stamped in order to obtain a visa.</b>

                                            When the embassy returns the passport stamped with the super visa, you are ready to travel to Canada.</b>
                                        </p>

                                        <h4 class="">Application fees and processing times (Visitor/Super VISA) </h4>

                                        <p class="p-express">

                                            A super visa takes about 133 working days to process, whereas a tourist visa takes 58 business days. A $100 application fee is
                                            required for both visas. Biometrics may come with a fee; the cost is approximately CAN $85.

                                        </p>
                                        <h4 class="">require the help of VISA specialists </h4>

                                        <p class="p-express">

                                            Applicants wishing to apply for any of these visas will need professional advice to ensure they are headed in the right way.
                                            You can obtain professional assistance with Indowest, which simplifies the visa application process.
                                            Many visas have already been accepted by the embassy thanks to the efforts of our VISA consultants, who are reputable for providing
                                            honest and open services. Give us your dreams, and we'll see to it that they come true.
                                        </p>
