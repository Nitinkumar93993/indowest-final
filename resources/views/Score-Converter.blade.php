                ...
                <div class="col-xl-12 col-lg-12 col-md-7 col-sm-7 col-xs-8 mx-auto">
                    <div class="faq-wrapp">
                        <div class="acer">
                            ...
                            <button class="hplinks" onclick="window.location.href = '/English-Language-Assessment';">English
                                Language
                                Assessment</button>
                            <button class="hplinks" onclick="window.location.href = '/CRS-Calculator';">CRS
                                Calculator</button>
                            <button class="hplinks" onclick="openCity(event, '/Score-Converter')" id="aceropen">Score
                                Converter</button>
                        </div>
