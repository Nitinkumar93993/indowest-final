                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-7 col-sm-7 col-xs-8 mx-auto">
                            <div class="faq-wrapp">
                                ...
                                <div class="acer">
                                    <button class="hplinks"
                                        onclick="window.location.href = '/study-visa-eliglibity';">Study
                                        Visa Eligibility</button>
                                    <button class="hplinks"
                                        onclick="window.location.href = '/English-Language-Assessment';">English
                                        Language
                                        Assessment</button>
                                    <button class="hplinks" onclick="window.location.href = '/CRS-Calculator';">CRS
                                        Calculator</button>
                                    <button class="hplinks" onclick="openCity(event, 'Score-Converter')"
                                        id="aceropen">Score
                                        Converter</button>
                                </div>

                                <div id="Study Visa Eligibility" class="acercontent" style="display:block !important">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-lg-12 d-flex justify-content-end">
                                                    <div class="header_btn mr-20">
                                                        <a class="cmt-btn cmt-btn-size-md cmt-btn-shape-round cmt-btn-style-border cmt-btn-color-white submit-modal"
                                                            id="become-a-member-1" href="">Start</a>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <!-- <div class="header_btn mr-20 faq-reset-btn">
                                <a class="cmt-btn cmt-btn-size-md cmt-btn-shape-round"
                                    id="become-a-member-1" href="">Reset</a>
                            </div> -->
                        </div>
                    </div>
                </div>
