                            ...
                            <div class="inhouse-heading-tit">
                                <div class="section-title">
                                    <div class="title-header">
                                        <h2 class="inhouse-course-heading">Book Reality Test Form</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6 col-sm mt-15">
                                            ...
                                            <select class="basic simple">
                                                ...
                                                <option class="select-branch-head" value="me">SPOKEN ENGLISH
                                                </option>
                                                <option class="select-branch-head" value="me">PTE for UKVI
                                                </option>
                                            </select>
                                        </div>
