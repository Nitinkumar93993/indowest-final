...
<head>
    ...
    <meta name=”keywords” content="Indo-West">
...
<body>
    {{-- <div class="page-loader"> <!-- Initially hide the loader -->
    ...
    <div class="page">
        ...
        <header id="masthead" class="header cmt-header-style-02">
            ...
            <nav class="top-bar social-topnav">
                ...
                <div class="Marquee">
                    <div class="Marquee-content">
                        <div class="Marquee-tag">Indo-West Excels: Entry
                            2024 Draw</div>
                        <div class="Marquee-tag">Indo-West Excels: Entry
                            2024 Draw</div>
                        <div class="Marquee-tag">Indo-West Excels: Entry
                ...
                <div class="top-bar-right nav-desktop">
                    <ul class="menu menu-desktop">
                        <li>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 loginformsec">
                                                    ...
                                                    <select name="loginType" class="select-branch-head"
                                                        ...
                                                        <option value="meemail">Email
                                                        </option>
                                                        <option value="me">Unique ID</option>
                                                    </select>
                                                </div>
                            ...
                            <form id="RegisterAlgform" method="POST" action="{{ url('/') }}/dashboard">
                                ...
                                <div id="loginregistermodal">
                                    <div class="modal-content-2">
                                        <div class="d-flex justify-content-between">
                                            <h5 class="register-heading text-left">
                                                Registration
                                            </h5>
                                            <button class="bnd" id="closeRegisteralg">&times;</button>
                                        </div>
                                        <div class="container">
                                            <div class="row">
                                                <div id="initialForm">
                        ...
                        <li><a class="animated-text" href="/bookcounselling">BOOK COUNSELLING</a></li>
                    </ul>
            ...
            <div id="site-header-menu" class="site-header-menu cmt-bgcolor-darkgrey">
                <div style="background-color: #fff;" class="site-header-menu-inner cmt-stickable-header">
                                                    ...
                                                    <ul style="height: 304px;" class="mega-submenu">
                                                        ...
                                                        <li class="mega-menu-item">
                                                            ...
                                                            <ul class="mega-submenu">
                                                                <li><a href="/our-branch-ambala-city">AMBALA
                                                                        CITY</a></li>
                                                                <li><a href="/our-branch-ambala-cantt">AMBALA
                                                                        CANTT</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="mega-menu-item">
                                                    ...
                                                    <ul style="height: 60px;" class="mega-submenu">
                                                        <li class="mega-menu-item">
                                                            ...
                                                            <ul class="mega-submenu" id="study-visa">
                                                                <li><a href="/study-visa-canada">Canada</a></li>
                                                                <li><a href="/study-visa-Australia">Australia</a>
                                                                </li>
                                                                <li><a href="/study-visa-United-Kingdom">United
                                                                        Kingdom</a></li>
                                                                <li><a href="/study-visa-United-States">United
                                                                        States</a></li>
                                                                <li><a href="/study-visa-New-Zealand">New
                                                                        Zealand</a></li>
                                                                <li><a href="/study-visa-Ireland">Ireland</a>
                                                                </li>
                                                                <li><a href="/study-visa-France">France</a>
                                                                </li>
                                                                <li><a href="/study-visa-Denmark">Denmark</a>
                                                                </li>
                                                                <li><a href="/study-visa-Netherlands">Netherlands</a>
                                                                </li>
                                                                <li><a href="/study-visa-Czech-Republic">Czech
                                                                        Republic</a></li>
                                                                <li><a href="/study-visa-Latvia">Latvia</a>
                                                                </li>
                                                                <li><a href="/study-visa-Lithuania">Lithuania</a>
                                                                </li>
                                                                <li><a href="/study-visa-Poland">Poland</a>
                                                                </li>
                                                                <li><a href="/study-visa-Hungary">Hungary</a>
                                                                </li>
                                                                <li><a href="/study-visa-Switzerland">Switzerland</a>
                                                                </li>
                                                                <li><a href="/study-visa-Malta">Malta</a>
                                                                </li>
                                                                <li><a href="/study-visa-South-Korea">South
                                                                        Korea</a></li>
                                                                <li><a href="/study-visa-Singapore">Singapore</a>
                                                                </li>
                                                                <li><a href="/study-visa-Cyprus">Cyprus</a>
                                                                </li>
                                                                <li><a href="/study-visa-Greece">Greece</a>
                                                                </li>
                                                                <li><a href="/study-visa-Italy">Italy</a>
                                                                </li>
                                                                <li><a href="/study-visa-Germany">Germany</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <ul style="height: 60px;" class="mega-submenu">
                                                        <li class="mega-menu-item">
                                                            ...
                                                            <ul class="mega-submenu" id="visitor-visa">
                                                                <li><a href="/visitor-visa-Canada">Canada</a></li>
                                                                <li><a href="/visitor-visa-Australia">Australia</a>
                                                                </li>
                                                                <li><a href="/visitor-visa-United-Kingdom">United
                                                                        Kingdom</a></li>
                                                                <li><a href="/visitor-visa-United-States">United
                                                                        States</a></li>
                                                                <li><a href="/visitor-visa-New-Zealand">New
                                                                        Zealand</a></li>
                                                                <li><a href="/visitor-visa-Germany">Germany</a>
                                                                </li>
                                                                <li><a href="/visitor-visa-Dubai">Dubai</a></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </li>
                                                    ...
                                                    <ul style="height: 304px;" class="mega-submenu mega-submenu-left">
                                                        <li class="mega-menu-item">
                                                            ...
                                                            <ul class="mega-submenu" id="work-visa">
                                                                <li><a href="/work-visa-Australia">Australia</a>
                                                                </li>
                                                                <li><a href="/work-visa-Canada">Canada</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="mega-menu-item">
                                                            ...
                                                            <ul class="mega-submenu" id="dependent-visa">
                                                                <li><a href="/dependent-visa-Canada">Canada</a>
                                                                </li>
                                                                <li><a href="/dependent-visa-Australia">Australia</a>
                                                                </li>
                                                                <li><a href="/dependent-visa-United-Kingdom">United
                                                                        Kingdom</a></li>
                                                                <li><a href="/dependent-visa-United-States">United
                                                                        States</a></li>
                                                                <li><a href="/dependent-visa-New-Zealand">New
                                                                        Zealand</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="mega-menu-item">
                                                            ...
                                                            <ul class="mega-submenu" id="spouse-visa">
                                                                <li><a href="/spouse-visa-Canada">Canada</a></li>
                                                                <li><a href="/spouse-visa-Australia">Australia</a>
                                                                </li>
                                                                <li><a href="/spouse-visa-United-Kingdom">United
                                                                        Kingdom</a></li>
                                                                <li><a href="/spouse-visa-United-States">United
                                                                        States</a></li>
                                                                <li><a href="/spouse-visa-New-Zealand">New
                                                                        Zealand</a></li>
                                                            </ul>
                                                        </li>
                                                        <li class="mega-menu-item">
                                                            ...
                                                            <ul class="mega-submenu" id="permanent-visa">
                                                                <li><a href="/permanent-resi-Australia">Australia</a>
                                                                </li>
                                                                <li><a href="/permanent-resi-Canada">Canada</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="mega-menu-item">
                                                            ...
                                                            <ul class="mega-submenu" id="migrationnewdrop">
                                                                <li class="mega-menu-item">
                                                                    ...
                                                                    <ul class="mega-submenu" id="canada">
                                                                        <li><a href="/EXPRESS-ENTRY">EXPRESS
                                                                                ENTRY</a></li>
                                                                        <li><a href="/STUDY-PERMIT-EXTENSION">STUDY
                                                                                PERMIT
                                                                                (EXTENSION)</a></li>
                                                                        <li><a href="/POST-GRADUATION-WORK-PERMIT">POST
                                                                                GRADUATION
                                                                                WORK
                                                                                PERMIT</a></li>
                                                                        <li><a href="/FAMILY-SPOUSAL-SPONSORSHIP">FAMILY
                                                                                /
                                                                                SPOUSAL
                                                                                SPONSORSHIP</a></li>
                                                                        <li><a href="/SUPER-VISA-VISITOR-VISA">SUPER
                                                                                VISA
                                                                                /
                                                                                VISITOR
                                                                                VISA</a></li>
                                                                        <li><a href="/LMIA">LABOUR
                                                                                MARKET
                                                                                IMPACT
                                                                                ASSESSMENT
                                                                                (LMIA)</a></li>
                                                                        <li><a href="/INVESTOR-ENTREPRENEUR-VISA">INVESTOR
                                                                                /
                                                                                ENTREPRENEUR
                                                                                VISA</a></li>
                                                                        <li><a href="/SPOUSAL-OPEN-WORK-PERMIT">SPOUSAL
                                                                                OPEN
                                                                                WORK
                                                                                PERMIT</a></li>
                                                                    </ul>
                                                                ...
                                                                <li class="mega-menu-item">
                                                                    ...
                                                                    <ul class="mega-submenu" id="Australia">
                                                                        ...
                                                                        <li><a href="/Skill-Assessment-Australia">Skill
                                                                                Assessment
                                                                                Australia</a></li>
                                                                        <li><a href="/Bridging-Visa-Australia">Bridging
                                                                                Visa
                                                                                Australia</a></li>
                                                                        <li><a href="/Change-Course-Australia">Change
                                                                                Course
                                                                                Australia</a></li>
                                                                        <li><a href="/General-Skilled-Migration">General
                                                                                Skilled
                                                                                Migration</a></li>
                                                                        <li><a href="/Parent-VISA">Parent
                                                                                VISA</a>
                                                                        </li>
                                                                        <li><a href="/Student-Visa-Australia">Student
                                                                                Visa
                                                                                -
                                                                                Australia</a></li>
                                                                        ...
                                                                        <li><a
                                                                                ...
                                                                                SPOUSAL
                                                                                SPONSORSHIP</a></li>
                                                                        <li><a href="/Tourist-Visa-Australia">Tourist
                                                                                Visa
                                                                                -
                                                                                Australia</a></li>
                                                                        <li><a href="/Citizenship-Program">Citizenship
                                                                                Program</a>
                                                                        </li>
                                                                        <li><a href="/Employer-Sponsored-Visa">Employer-Sponsored
                                                                                Visa</a></li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
