                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            <div class="page-title-heading">
                                <h2 class="title">Diplomatic & Offical Visa</h2>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span>Diplomatic & Offical Visa</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div
                            ...
                            <aside class="widget widget-nav-menu">
                                <ul class="widget-menu">
                                    ...
                                    <li class="active"><a href="diplomatic-Offical-visa.html">Diplomatic & Offical
                                            Visa</a></li>
                            ...
                            <aside class="widget widget-contact">
                                ...
                                <div
                                    class="cmt-col-bgcolor-yes cmt-bgcolor-skincolor cmt-bg pt-20 pl-20 pr-20 pr-20 pb-20">
                            ...
                            <aside class="widget widget-form with-title">
                                ...
                                <form id="immigration_form" class="immigration_form wrap-form clearfix" method="post"
                                    ...
                                    <label>
                                        <span class="text-input">
                                            <select id="search_category" name="search_category" aria-invalid="false">
                                                ...
                                                <option value="Diplomatic &amp; Offical Visa">SDiplomatic &amp; Offical
                                                    Visa</option>
                        ...
                        <div class="col-lg-8 content-area">
                            <div class="cmt-service-single-content-area">
                                <div class="cmt-featured-wrapper mb-40 res-991-mb-20">
                                    <img class="img-fluid" src="images/services/services-details_02.jpg" alt="">
                                </div>
                                <div class="cmt-service-description">
                                    ...
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        ...
                                        unknown printer.</p>
                                    <div
                                        class="mt-30 mb-30 cmt-bgcolor-white box-shadow pt-20 pb-15 pl-30 res-991-pl-15 pr-15">
                                                    ...
                                                    <div class="cmt-fid-contents">
                                                        <h4 class="cmt-fid-inner">
                                                            <span data-appear-animation="animateDigits" data-from="0"
                                                                data-to="15" data-interval="3" data-before=""
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 cmt-box-col-wrapper">
                                                ...
                                                <div class="cmt-fid inside cmt-fid-with-icon cmt-fid-view-lefticon">
                                                    ...
                                                    <div class="cmt-fid-contents">
                                                        <h4 class="cmt-fid-inner">
                                                            <span data-appear-animation="animateDigits" data-from="0"
                                                                data-to="1490" data-interval="15" data-before=""
                                                                data-before-style="sup" data-after=""
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 cmt-box-col-wrapper">
                                                ...
                                                <div class="cmt-fid inside cmt-fid-with-icon cmt-fid-view-lefticon">
                                                    ...
                                                    <div class="cmt-fid-contents">
                                                        <h4 class="cmt-fid-inner">
                                                            <span data-appear-animation="animateDigits" data-from="0"
                                                                data-to="850" data-interval="15" data-before=""
                                                                data-before-style="sup" data-after=""
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="ttm_single_image-wrapper res-991-pb-30">
                                                    <img class="img-fluid" src="images/single-img-12.jpg"
                                                        alt="single_12">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                    ...
                                                    ever since the 1500s. It has survived not only five centuries.</p>
                                                <ul
                                                    class="cmt-list cmt-list-style-icon cmt-list-icon-color-skincolor pt-5">
                                                    <li><i class="cmt-textcolor-skincolor fa fa-check-circle"></i><span
                                                            class="cmt-list-li-content">Which material types can you
                                                            work with?</span>
                                                    </li>
                                                    <li><i class="cmt-textcolor-skincolor fa fa-check-circle"></i><span
                                                            class="cmt-list-li-content">Can I have multiple in a single
                                                            feature?</span>
                                                    </li>
                                                    <li><i class="cmt-textcolor-skincolor fa fa-check-circle"></i><span
                                                            class="cmt-list-li-content">Is Smart Lock required for
                                                            instant apps?</span>
                                                    </li>
                                                    <li><i class="cmt-textcolor-skincolor fa fa-check-circle"></i><span
                                                            class="cmt-list-li-content">Which material types can you
                                    ...
                                    <div class="accordion pt-15">
                                        ...
                                        <div class="toggle cmt-control-left-true">
                                            <div class="toggle-title"><a href="#">Do You Have A Covered Health Insurance
                                                    For This Journey?</a></div>
                                            <div class="toggle-content">
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                    industry. Lorem Ipsum has been the industry. It has survived not
                                        ...
                                        <!-- toggle -->
                                        <div class="toggle cmt-control-left-true">
                                            <div class="toggle-title"><a href="#">What do you know about the country you
                                                    are visiting?</a></div>
                                            <div class="toggle-content">
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                    industry. Lorem Ipsum has been the industry. It has survived not
                                        ...
                                        <!-- toggle -->
                                        <div class="toggle cmt-control-left-true">
                                            <div class="toggle-title"><a href="#" class="active">How Much This Journey
                                                    Will Cost You?</a></div>
                                            <div class="toggle-content">
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                    industry. Lorem Ipsum has been the industry. It has survived not
                                        ...
                                        <!-- toggle -->
                                        <div class="toggle cmt-control-left-true">
                                            <div class="toggle-title"><a href="#">How to take time in the procesing of
                                                    ragistration?</a></div>
                                            <div class="toggle-content">
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting
                                                    industry. Lorem Ipsum has been the industry. It has survived not
