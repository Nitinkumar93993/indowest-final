                            ...
                            <div class="inhouse-heading-tit">
                                <div class="section-title">
                                    <!-- <div class="title-header">
                                        <h2 class="inhouse-course-heading">ONLINE COURSES</h2>
                                    </div> -->
                                    <div class="title-header">
                                        <h2 class="inhouse-course-heading">COMING SOON.....</h2>
                                    </div>
                                    <!-- <div class="title-header">
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12 mt-25">
                            <div class="card celpip-card-border">
                                <div class="celpip-body">
                                    ...
                                    <h4 class="celpip-title">PTE- GT | 90 DAYS</h4>
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12 mt-25">
                            <div class="card celpip-card-border">
                                <div class="celpip-body">
                                    ...
                                    <h4 class="celpip-title">PTE- GT | 60 DAYS</h4>
                                    <div class="celpip-text">
                                        <p class="card-text">Branch: AMBALA</p>
                                        <p class="card-text">Module: LISTENING, READING, SPEAKING, WRITING
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12 mt-25">
                            <div class="card celpip-card-border">
                                <div class="celpip-body">
                                    ...
                                    <h4 class="celpip-title">PTE- GT | 30 DAYS</h4>
                                    <div class="celpip-text">
                                        <p class="card-text">Branch: AMBALA</p>
                                        <p class="card-text">Module: LISTENING, READING, SPEAKING, WRITING
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12 mt-25">
                            <div class="card celpip-card-border">
                                <div class="celpip-body">
                                    ...
                                    <h4 class="celpip-title">PTE- GT | 15 DAYS</h4>
                                    <div class="celpip-text">
                                        <p class="card-text">Branch: AMBALA</p>
                                        <p class="card-text">Module: LISTENING, READING, SPEAKING, WRITING
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12 mt-25">
                            <div class="card celpip-card-border">
                                <div class="celpip-body">
                                    ...
                                    <h4 class="celpip-title">PTE- ACA | Online | 15 Days Pack</h4>
                                    <div class="celpip-text">
                                        <p class="card-text">Branch: AMBALA</p>
                                        <p class="card-text">Module: LISTENING, READING, SPEAKING, WRITING
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12 mt-25">
                            <div class="card celpip-card-border">
                                <div class="celpip-body">
                                    ...
                                    <h4 class="celpip-title">PTE- ACA| 60 DAYS</h4>
                                    <div class="celpip-text">
                                        <p class="card-text">Branch: AMBALA</p>
                                        <p class="card-text">Module: LISTENING, READING, SPEAKING, WRITING
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12 mt-25">
                            <div class="card celpip-card-border">
                                <div class="celpip-body">
                                    ...
                                    <h4 class="celpip-title">PTE- ACA| 30 DAYS</h4>
                                    <div class="celpip-text">
                                        <p class="card-text">Branch: AMBALA</p>
                                        <p class="card-text">Module: LISTENING, READING, SPEAKING, WRITING
                        ...
                        <div class="col-lg-4 col-sm-4 col-md-4 col-xl-4 col-xs-12 mt-25">
                            <div class="card celpip-card-border">
                                <div class="celpip-body">
                                    ...
                                    <h4 class="celpip-title">PTE- ACA | 15 DAYS</h4>
                                    <div class="celpip-text">
                                        <p class="card-text">Branch: AMBALA</p>
                                        <p class="card-text">Module: LISTENING, READING, SPEAKING, WRITING
