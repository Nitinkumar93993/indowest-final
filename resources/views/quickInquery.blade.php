<div class="card" style="width: 100%;">
    <form action="{{url('/')}}/EXPRESS-ENTRY" method="post">
        @csrf
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-6 mt-15">
                    <label for="formGroupExampleInput" class="form-label">Countery
                        Code</label>
                    <select style="padding: 8px 8px 8px 8px;" name="selectCountryCode" class="form-select "
                        aria-label="Default select example" required>
                        <option data-countryCode="IN" value="91" Selected>IN (+91)
                        </option>
                ...
                <div class="col-md-6 mt-15">
                    ...
                    <input type="email" class="form-control" id="inputEmail4 "
                        placeholder="" name="email" aria-label="nitin@gmail.com" required>
                </div>
                <div class="col-md-6 mt-15">
                    <label for="inputdate" class="form-label">DOB</label>
                    <input type="date" class="form-control" id="inputEmail4"
                        placeholder="" name="dateofbirth" aria-label="nitin@gmail.com" required>
                </div>
                <div class="col-md-12">
                    <label>Put Your Inquery</label>
                    <span class="text-input">
                        <textarea name="message" rows="4" placeholder="" required="required"></textarea>
                    </span>
                </div>
