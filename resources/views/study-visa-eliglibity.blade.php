                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-7 col-sm-7 col-xs-8 mx-auto">
                        <div class="faq-wrapp">
                            ...
                            <div class="acer">
                                <button class="hplinks" onclick="openCity(event, 'Study Visa Eligibility')"
                                    id="aceropen">Study
                                    ...
                                    <div class="container ">
                                        ...
                                        <div class="row">
                                            <form id="otpForm">
                                                ...
                                                <br>
                                                <div class="col-sm-6">
                                                    <label class="label-heading-modal" for="mobileNumber">Phone
                                                        Number</label>
                                                ...
                                                <div class=" col-lg-12 d-flex justify-content-end">
                                                    <div class="header_btn mr-20">
                                                        <button type="button" onclick="sendOTP()" class="cmt-btn cmt-btn-size-md cmt-btn-shape-round cmt-btn-style-border cmt-btn-color-white submit-modal"
                                                            id="become-a-member-1">Start</button>
                                                    </div>
                                                </div>                            
                                            </form>
